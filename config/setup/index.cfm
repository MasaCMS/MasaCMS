...
<header>
  <div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
      <div class="container"><a class="brand" href="http://www.getmura.com" title="Mura CMS"><img src="admin/assets/images/mura_logo.png"></a></div>
      <!--/.container -->
    </div>
  </div>
  </div>
	...
	theCFServer = "ColdFusion";
            ...
            <fieldset class="notice">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <input type="radio" name="auto_create" value="Yes" id="auto_create_on"  onclick="javascript:fHandleAutoCreateChange()"> Yes</label>
                  <label class="inline radio"><input type="radio" name="auto_create" value="No" id="auto_create_off" checked onclick="javascript:fHandleAutoCreateChange()"> No
                	</label>
                </div>
              </div>
              ...
              </span> <span id="ac_cfpass_span" style="display:none;">
              <div class="control-group">
            ...
            <fieldset>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <label class="inline radio"><input type="radio" name="production_siteidinurls" value="1" id="siteidinurls_on"<cfif yesNoFormat(form.production_siteidinurls)> checked</cfif>> Yes</label>
                  <label class="inline radio"><input type="radio" name="production_siteidinurls" value="0" id="siteidinurls_off"<cfif not yesNoFormat(form.production_siteidinurls)> checked</cfif>> No</label>
                </div>
              </div>
              ...
              <div class="control-group">
                <label class="control-label"><a href="" rel="tooltip" data-original-title="If set to "No" you must ensure that you have properly configured your webserver's URL rewriting. Toggling this alone will not remove index.cfm from yoru URLs.">Use "index.cfm" in URLS <i class="icon-info-sign"></i></a></label>                  
                  <div class="controls">
                	<label class="inline radio">
                  <input type="radio" name="production_indexfileinurls" value="1" id="indexfileinurls_on"<cfif yesNoFormat(form.production_indexfileinurls)> checked</cfif>> Yes</label>
                  <label class="inline radio"><input type="radio" name="production_indexfileinurls" value="0" id="indexfileinurls_off"<cfif not yesNoFormat(form.production_indexfileinurls)> checked</cfif>> No
                	</label>
                </div>
              </div>
