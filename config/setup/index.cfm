...
<div class="main">
  <div class="main-inner"> 
    ...
    <form id="frm" class="form-horizontal<cfif isDefined( "FORM.#session.setupSubmitButton#" ) AND errorType IS ""> install-complete<cfelse> setup-form</cfif>" name="frm" action="index.cfm" method="post" onsubmit="return processInstallFrm(this);" onclick="return validateForm(this);">
      ...
      <cfif isDefined( "FORM.#session.setupSubmitButton#" ) AND errorType IS "">
        ...
        <div id="finishSetUp" class="form-actions">
        	<input type="submit" class="btn" name="#session.setupSubmitButtonComplete#" value="Login to Mura" />
        </div>
...
--->
      ...
      <div class="form-actions">
        <input class="btn" type="submit" name="#session.setupSubmitButton#" value="Save Settings" />
      </div>
      </cfif>
    </form>
