...
<cfif isDefined( "FORM.#application.setupSubmitButton#" ) AND errorType IS "">
		<div id="installationComplete" class="success">
			...
			<input type="submit" name="#application.setupSubmitButtonComplete#" value="Finish Set Up and Take Me to the Mura Admin" />
		</div>
</cfif>
...
<dl class="twoColumn notice">
	...
	<dd ><input type="text" name="production_dbtablespace" value="#FORM.production_dbtablespace#"></dd>
	</span>
...
<p>By default, Mura is set to use the mail server specified in your application server. If you would like to override this setting to use a specific mail server and mail account, complete the settings below.</p>
	...
	<input class="submit" type="submit" name="#application.setupSubmitButton#" value="Save Settings" />
</form>
</cfoutput>
