...
jQuery(document).ready(function(){
	...
	$(".database-config").toggle(#(val(len(trim(FORM.production_dbtype)) gt 0))#);
	...
	$(".database-create-oracle").toggle(#val(FORM.production_dbtype eq 'oracle' and val(FORM.auto_create) eq 1)#);
