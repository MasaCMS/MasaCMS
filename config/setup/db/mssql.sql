if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tadcampaigns]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tadcampaigns]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tadcreatives]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tadcreatives]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tadipwhitelist]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tadipwhitelist]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tadplacementdetails]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tadplacementdetails]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tadplacements]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tadzones]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tadzones]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tcaptcha]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tcaptcha]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tcontent]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tcontent]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tcontentstats]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tcontentstats]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tcontentassignments]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tcontentassignments]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tcontentcategories]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tcontentcategories]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tcontentcategoryassign]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tcontentcategoryassign]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tcontentcomments]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tcontentcomments]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tcontenteventreminders]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tcontenteventreminders]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tcontentfeedadvancedparams]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tcontentfeedadvancedparams]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tcontentfeeditems]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tcontentfeeditems]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tcontentfeeds]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tcontentfeeds]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tcontentobjects]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tcontentobjects]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tcontentdisplaytitleapprovals]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tcontentdisplaytitleapprovals]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tcontentratings]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tcontentratings]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tcontentrelated]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tfiles]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tglobals]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tglobals]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tmailinglist]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tmailinglist]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tmailinglistmembers]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tmailinglistmembers]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tpermissions]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tpermissions]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tredirects]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tsettings]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tsettings]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tsystemobjects]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tusersfavorites]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tusersfavorites]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tusersinterests]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tusersinterests]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tusersmemb]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tusersmemb]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tcontentpublicsubmissionapprovals]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[tcontentpublicsubmissionapprovals]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tcontenttags]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tclassextenddata]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
...
INSERT INTO [dbo].[tcontent] ([SiteID],[ModuleID],[ParentID],[ContentID],[ContentHistID],[RemoteID],[RemoteURL],[RemotePubDate],[RemoteSourceURL],[RemoteSource],[Credits],[FileID],[Template],[Type],[subType],[Active],[OrderNo],[Title],[MenuTitle],[Summary],[Filename],[MetaDesc],[MetaKeyWords],[Body],[lastUpdate],[lastUpdateBy],[lastUpdateByID],[DisplayStart],[DisplayStop],[Display],[Approved],[IsNav],[Restricted],[RestrictGroups],[Target],[TargetParams],[responseChart],[responseMessage],[responseSendTo],[responseDisplayFields],[moduleAssign],[displayTitle],[Notes],[inheritObjects],[isFeature],[ReleaseDate],[IsLocked],[nextN],[sortBy],[sortDirection],[featureStart],[featureStop],[forceSSL],[audience],[keyPoints],[searchExclude],[path]) VALUES ('default','00000000000000000000000000000000000','00000000000000000000000000000000END','00000000000000000000000000000000001','6300ED69-1320-5CC3-F922E3012E2C6BAE',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'default.cfm','Page','Default',1,1,'Home Page','Home Page',NULL,NULL,NULL,NULL,NULL,getDate(),'System',NULL,NULL,NULL,1,1,1,0,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,NULL,'Cascade',0,NULL,0,10,'orderno','asc',NULL,NULL,0,NULL,NULL,0,'''00000000000000000000000000000000001''');
