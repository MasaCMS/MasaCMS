...
<cfset contentLink = "<a href=""#application.configBean.getIndexFile()#"" onClick=""return deleteFavorite('#favorite.getfavoriteID()#', 'favorite#lid#');"" title=""remove from favorites"" class=""remove"">[-]</a> " & contentLink />
