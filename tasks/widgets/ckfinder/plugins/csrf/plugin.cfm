<cffunction name="CheckCSRF" returntype="Boolean" output="true">
	...
	<cfif structKeyExists(server,'railo') and listcontains("CopyFiles,CreateFolder,DeleteFiles,DeleteFolder,FileUpload,GetFiles,MoveFiles,RenameFile,RenameFolder", command)>
