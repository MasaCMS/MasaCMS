...
(function() {
  ...
  var config = {
    // General
    player: CKEDITOR.basePath + 'plugins/media/mediaplayer-5.2/player.swf', 
    replacement: CKEDITOR.basePath + 'plugins/media/images/replacement.gif',
    swfobject: CKEDITOR.basePath + 'plugins/media/mediaplayer-5.2/swfobject.js',
    yt: CKEDITOR.basePath + 'plugins/media/mediaplayer-5.2/yt.swf',
