		                ...
		                "default" : {
		                    "select_node" : function (target) {
								...
								if(type == 'aud'){
									...
									var content='<tbody><tr><td><img src="'+$(target).attr('data-' + razuna_servertype + '_url_thumb')+'" id="show-image"></td><td valign="top"><strong>File name : </strong><span>'+$(target).attr('data-filename_org')+'</span><br><strong>Kind:</strong><span>Image</span><br><table border="0" id="renditions"><tr><td><strong>Size:</strong></td><td><div class="image-size-item"><input type="radio" checked="checked" name="radio_path" class="image-size-thumbnail radio" value="'+$(target).attr('data-' + razuna_servertype + '_url_thumb')+'" id="radio_path" data-height="'+$(target).attr('data-height')+'" data-width="'+$(target).attr('data-width')+'"><label for="image-size" class="form_labels">Thumbnail</label></div></td></tr><tr ><td>&nbsp;</td><td ><div class="image-size-item"><input type="radio" name="radio_path" class="image-size-original radio" value="'+$(target).attr('data-' + razuna_servertype + '_url_org')+'" id="radio_path"><label for="image-sizeorig" class="form_labels">Original</label></div></td></tr></table></td></tr><tr><td><strong>Alternate text:</strong></td><td><input type="text" id="alt_text" value="'+$(target).attr('data-filename_org')+'" class="alt"></td></tr><tr><td><strong>Title:</strong></td><td><input type="text" value="" id="img_title_text"></td></tr><tr><td><strong>Link URL:</strong></td><td><input type="text" class="urlfield text"></td></tr><tr><td style="text-align:center;" colspan="3"><br><button onclick="'+none+'" class="btn none">None</button>&nbsp;&nbsp;<button onclick="'+original+'" class="btn image_org">File Original Size</button>&nbsp;&nbsp;<button onclick="'+thumbnail+'" class="btn image_thumb">File Thumbnail Size</button>&nbsp;&nbsp;</td></tr><tr><td colspan="3" style="text-align:center;"><br><button id="insert_into_post" class="btn image">Insert into Post</button></td></tr></tbody>';
								}
								else if(type == 'doc'){
