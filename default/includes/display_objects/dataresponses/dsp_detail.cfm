				...
				<cfloop list="#variables.fieldnames#" index="variables.f">
					...
					<dd>
						<cfif findNoCase('attachment',variables.f) and isValid("UUID",fvalue)>
							<a  href="http://#application.settingsManager.getSite(session.siteid).getDomain()##application.configBean.getServerPort()##application.configBean.getContext()#/index.cfm/_render/file/?fileID=#variables.fvalue#">#application.rbFactory.getKeyValue(session.rb,'sitemanager.content.fields.viewattachment')#</a>
						<cfelse>
