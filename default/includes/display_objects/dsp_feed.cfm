...
<cfif variables.feedBean.getIsActive()>
	...
	<cfif variables.feedBean.getType() eq 'local'>
		...
		<cfif variables.iterator.getRecordCount()>
			<cfoutput>
				<div class="#this.localIndexWrapperClass# #variables.feedBean.getCssClass()#" id="#variables.cssID#">
	...
	<cfelse>
		...
		<cfoutput>
			<cfif isDefined("variables.feedData.maxItems") and variables.feedData.maxItems>
				<div class="#this.remoteFeedWrapperClass# #variables.feedBean.getCssClass()#" id="#variables.cssID#">
