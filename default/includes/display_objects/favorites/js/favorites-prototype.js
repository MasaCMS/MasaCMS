...
function saveFavorite(userID, siteID, favoriteName, favoriteLocation, favoriteType)
{
	//if (!favoriteExists){
		...
		var url = mura.assetpath + '/includes/display_objects/favorites/ajax/saveFavorite.cfm';
...
{
	var url = mura.assetpath + '/includes/display_objects/favorites/ajax/deleteFavorite.cfm';
	//var pars = 'empID=' + empID + '&year=' + y;
