...
<cfoutput>
	#variables.$.getContentListPropertyValue('itemEl','openingOuterMarkUp',arguments.propertyMap)#
	<#variables.$.getContentListPropertyValue('itemEl','tag',arguments.propertyMap)# class="mura-item-meta">
		#variables.$.getContentListPropertyValue('itemEL',"openingInnerMarkUp",arguments.propertyMap)#
		<cfloop list="#arguments.fields#" index="arguments.field">
			...
			#variables.$.getContentListPropertyValue(arguments.field,"openingOuterMarkUp",arguments.propertyMap)#
			<cfswitch expression="#arguments.field#">
				<cfcase value="Date">
					<cfif arguments.type eq 'Folder' and isDate(arguments.item.getValue('releaseDate'))>
						...
						#variables.$.getContentListPropertyValue(arguments.field,"openingInnerMarkUp",arguments.propertyMap)#
						...
						</#variables.$.getContentListPropertyValue(arguments.field,'tag',arguments.propertyMap)#>
				...
				<cfcase value="Title">
					<#variables.$.getContentListPropertyValue(arguments.field,'tag',arguments.propertyMap)# class="mura-item-meta__title">
					#variables.$.getContentListPropertyValue(arguments.field,"openingInnerMarkUp",arguments.propertyMap)#
						#variables.$.getContentListLabel(arguments.field,arguments.propertyMap)#
				...
				<cfcase value="Summary">
					<cfif len(arguments.item.getValue('summary')) and arguments.item.getValue('summary') neq "<p></p>">
					 	<#variables.$.getContentListPropertyValue(arguments.field,'tag',arguments.propertyMap)# class="mura-item-meta__summary">
					 	#variables.$.getContentListPropertyValue(arguments.field,"openingInnerMarkUp",arguments.propertyMap)#
					 		#variables.$.getContentListLabel(arguments.field,arguments.propertyMap)#
				...
				<cfcase value="Body">
					<cfif not listFindNoCase('File,Link',arguments.item.getValue('type'))>
						<cfif len(arguments.item.getValue('body')) and arguments.item.getValue('body') neq "<p></p>">
					 		<#variables.$.getContentListPropertyValue(arguments.field,'tag',arguments.propertyMap)# class="mura-item-meta__body">
					 		#variables.$.getContentListPropertyValue(arguments.field,"openingInnerMarkUp",arguments.propertyMap)#
					 			#variables.$.getContentListLabel(arguments.field,arguments.propertyMap)#
				...
				<cfcase value="ReadMore">
				 	<#variables.$.getContentListPropertyValue(arguments.field,'tag',arguments.propertyMap)# class="mura-item-meta__readmore">
				 	#variables.$.getContentListPropertyValue(arguments.field,"openingInnerMarkUp",arguments.propertyMap)#
				...
				<cfcase value="Credits">
					<cfif len(arguments.item.getValue('credits'))>
					 	<#variables.$.getContentListPropertyValue(arguments.field,'tag',arguments.propertyMap)# class="mura-item-meta__credits">
					 	#variables.$.getContentListPropertyValue(arguments.field,"openingInnerMarkUp",arguments.propertyMap)#
				...
				<cfcase value="Comments">
					<cfif not variables.$.event('muraMobileTemplate') and (arguments.item.getValue('type') eq 'Page' or showItemMeta(arguments.item.getValue('type')) or (len(arguments.item.getValue('fileID')) and showItemMeta(arguments.item.getValue('fileEXT')))) >
					 	<#variables.$.getContentListPropertyValue(arguments.field,'tag',arguments.propertyMap)# class="mura-item-meta__comments">
					 	#variables.$.getContentListPropertyValue(arguments.field,"openingInnerMarkUp",arguments.propertyMap)#
				...
				<cfcase value="Tags">
					<cfif len(arguments.item.getValue('tags'))>
						...
						<#variables.$.getContentListPropertyValue(arguments.field,'tag',arguments.propertyMap)# class="mura-item-meta__tags">
						#variables.$.getContentListPropertyValue(arguments.field,"openingInnerMarkUp",arguments.propertyMap)#
							#variables.$.getContentListLabel(arguments.field)# 
				...
				<cfcase value="Rating">
					<cfif (arguments.item.getValue('type') eq 'Page' or showItemMeta(arguments.item.getValue('type')) or (len(arguments.item.getValue('fileID')) and showItemMeta(arguments.item.getValue('fileEXT'))))>
					 	<#variables.$.getContentListPropertyValue(arguments.field,'tag',arguments.propertyMap)# class="mura-item-meta__rating #application.raterManager.getStarText(arguments.item.getValue('rating'))#">
					 	#variables.$.getContentListPropertyValue(arguments.field,"openingInnerMarkUp",arguments.propertyMap)#
					 		#variables.$.getContentListLabel(arguments.field,arguments.propertyMap)# 
				...
				<cfdefaultcase>
					<cfif len(arguments.item.getValue(arguments.field))>
						<!--- sys based dynamic classes are deprecated --->
					 	<#variables.$.getContentListPropertyValue(arguments.field,'tag',arguments.propertyMap)# class="mura-item-meta__#lcase(arguments.field)#">
					 	#variables.$.getContentListPropertyValue(arguments.field,"openingInnerMarkUp",arguments.propertyMap)#
					 			#variables.$.getContentListLabel(arguments.field,arguments.propertyMap)#
			...
			#variables.$.getContentListPropertyValue(arguments.field,"closingOuterMarkUp",arguments.propertyMap)#
			</cfif>
		</cfloop>
	#variables.$.getContentListPropertyValue('itemEl',"closingInnerMarkUp",arguments.propertyMap)#
	</#variables.$.getContentListPropertyValue('itemEl',"tag",arguments.propertyMap)#>
	#variables.$.getContentListPropertyValue('itemEl',"closingOuterMarkUp",arguments.propertyMap)#
</cfoutput>
