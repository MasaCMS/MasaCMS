...
<ol>
<li class="req"><label>#$.rbKey('stf.fname')#<ins> (#$.rbKey('stf.required')#)</ins></label><cfinput type="text"  name="fname" data-required="yes" data-message="#$.rbKey('stf.fnamerequired')#" size="20" maxlength="16" value="" class="text"></li>
<li class="req"><label>#$.rbKey('stf.lname')#<ins> (#$.rbKey('stf.required')#)</ins></label><cfinput type="text" name="lname" data-message="#$.rbKey('stf.lnamerequired')#" data-required="yes" size="20" maxlength="16" value="" class="text" /></li>
<li class="req"><label>#$.rbKey('stf.email')#<ins> (#$.rbKey('stf.required')#)</ins></label><cfinput type="text" name="email" data-message="#$.rbKey('stf.emailrequired')#"  data-required="yes" size="20" maxlength="47" value="" class="text" /></li>
...
<li><label>#$.rbKey('stf.recipientaddresses')#</label>
	...
	<li><span class="req"><cfinput type="text" name="sendto1" size="20" data-required="yes" data-message="#$.rbKey('stf.recipientrequired')#" maxlength="47" value="" class="text" /><ins> (#$.rbKey('stf.required')#)</ins></span></li>
...
<input type="hidden" name="siteID" value="#HTMLEditFormat($.event('siteID'))#"/>
  ...
  <!--- Form Protection --->
  <div>#$.dspObject_Include(thefile='dsp_form_protect.cfm')#</div>
