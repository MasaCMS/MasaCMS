...
<div id="svPortal" class="svIndex">
		...
		<dt class="releaseDate"><cfif LSDateFormat(rsSection.displaystart,"short") lt LSDateFormat(rsSection.displaystop,"short")>#LSDateFormat(rsSection.displaystart,getShortDateFormat())# - #LSDateFormat(rsSection.displaystop,getShortDateFormat())#<cfelse>#LSDateFormat(rsSection.displaystart,getLongDateFormat())#</cfif></dt>
		<dt>#link#</dt>
		<cfif hasImage>
		<dd class="image">
