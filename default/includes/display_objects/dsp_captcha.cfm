...
<input type="text" class="text" data-message="#application.settingsManager.getSite(variables.$.event('siteID')).getRBFactory().getKey('captcha.required')#" required="true" name="uKey" size="20">
