...
<cfsavecontent variable="variables.strField">
	...
	</label><input type="file" name="#arguments.prefix##arguments.field.name#_attachment" value="#arguments.field.value#"#variables.$.dspObject_Include(thefile='/formbuilder/fields/dsp_common.cfm',field=arguments.field,dataset=arguments.dataset)#</cfoutput>
</cfsavecontent>
</cfsilent>
<cfoutput>
