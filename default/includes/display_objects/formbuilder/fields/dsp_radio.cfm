...
<cfsavecontent variable="variables.strField">
	...
	<cfloop from="1" to="#ArrayLen(arguments.dataset.datarecordorder)#" index="variables.iiy">
		...
		<label for="#variables.record.datarecordid#"><input name="#arguments.field.name#" id="#record.datarecordid#" type="radio"<cfif variables.record.isselected eq 1> CHECKED</cfif> value="#variables.record.value#" class="form-control">#variables.record.label#</label>
	</cfloop>
	</div>
	</cfoutput>
</cfsavecontent>
