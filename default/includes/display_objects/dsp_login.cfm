					...
					<fieldset>
						...
						<div class="req #this.loginFormGroupWrapperClass#">
							...
							<div class="#this.loginFormFieldWrapperClass#">
								<input class="#this.loginFormFieldClass#" type="text" id="txtUsername" placeholder="#variables.$.rbKey('user.username')#" name="username" required="true" data-message="#htmlEditFormat(variables.$.rbKey('user.usernamerequired'))#" autofocus>
							</div>
						</div>
						...
						<div class="req #this.loginFormGroupWrapperClass#">
							...
							<div class="#this.loginFormFieldWrapperClass#">
								<input class="#this.loginFormFieldClass#" type="password" id="txtPassword" name="password" placeholder="#variables.$.rbKey('user.password')#" required="true" data-message="#htmlEditFormat(variables.$.rbKey('user.passwordrequired'))#">
							</div>
						</div>
				...
				<form name="form2" class="mura-send-login #this.forgotPasswordFormClass# <cfif this.formWrapperClass neq "">#this.formWrapperClass#</cfif>" method="post" action="?nocache=1" id="sendLogin" onsubmit="return validateForm(this);" novalidate="novalidate">
					<fieldset>
						...
						<div class="#this.loginFormGroupWrapperClass#">
							...
							<div class="#this.loginFormFieldWrapperClass#">
								<input id="txtEmail" name="email" class="#this.loginFormFieldClass#" type="text" placeholder="#variables.$.rbKey('user.email')#" data-validate="email" required="true" data-message="#htmlEditFormat(variables.$.rbKey('user.emailvalidate'))#" />
							</div>
						</div>
