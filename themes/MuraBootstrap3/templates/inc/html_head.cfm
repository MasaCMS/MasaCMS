...
<head>
	...
	<link rel="stylesheet" href="#$.globalConfig('context')#/modules/core_assets/css/mura.7.0.min.css?v=#$.siteConfig('version')#">
	...
	<link rel="stylesheet" href="#$.globalConfig('context')#/modules/core_assets/css/mura.7.0.skin.css?v=#$.siteConfig('version')#">
	...
	<!--- jQuery --->
	<script src="#$.globalConfig('context')#/modules/core_assets/js/external/jquery.min.js"></script>

	<!--- FAV AND TOUCH ICONS --->
	<link rel="shortcut icon" href="#$.globalConfig('context')#/modules/core_assets/images/favicon.ico">
