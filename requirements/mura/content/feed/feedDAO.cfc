...
<cffunction name="create" returntype="void" access="public" output="false">
	...
	imageSize,imageHeight,imageWidth,displayList,showNavOnly,showExcludeSearch,viewalllink,viewalllabel,autoimport)
	values (
