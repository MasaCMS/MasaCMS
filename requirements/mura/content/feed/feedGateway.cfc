		...
		<cfquery attributeCollection="#variables.configBean.getReadOnlyQRYAttrs(name='rsFeed',blockFactor=blockFactor)#">
			...
			FROM 
				...
				<cfif not len(arguments.feedBean.getAltTable())>
					...
					Left Join tcontentfilemetadata #tableModifier# on (tcontent.fileid=tcontentfilemetadata.fileid						and tcontent.contenthistid=tcontentfilemetadata.contenthistid)
				</cfif>
