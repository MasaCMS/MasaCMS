...
*/
component extends="mura.bean.bean" table="tcontentcategoryassign" entityname="contentCategoryAssign" bundleable=false {
    ...
    property name="isfeature" fieldtype="int" default=0;
    property name="featureStart" fieldtype="datetime" default=null;
    property name="featureSop" fieldtype="datetime" default=null;
