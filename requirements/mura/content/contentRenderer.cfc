...
<cfscript>
	...
	public any function getCalendarItems(
		...
		var tp = variables.$.initTracePoint('mura.content.contentRenderer.getCalendarItems');
		var local = {};
		...
		// the recordset/query
		local.rs = local.feed.getQuery(from=local.displaystart, to=local.displaystop);
