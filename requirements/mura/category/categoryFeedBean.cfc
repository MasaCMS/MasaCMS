...
--->
<cfcomponent extends="mura.bean.beanFeed" output="false" hint="This provides category feed functionality">

	<cfproperty name="bean" type="string" default="category" required="true" />
	<cfproperty name="table" type="string" default="tcontentcategories" required="true" />
	<cfproperty name="keyField" type="string" default="categoryID" required="true" />
	<cfproperty name="siteID" type="string" default="" required="true" />
	<cfproperty name="sortBy" type="string" default="name" required="true" />
