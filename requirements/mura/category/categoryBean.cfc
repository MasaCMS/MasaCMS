...
<cfproperty name="contentAssignments" fieldtype="one-to-many" cfc="contentCategoryAssign" />
...
<cffunction name="setURLTitle" output="false">
...
<cffunction name="setIsFeatureable" output="false">
