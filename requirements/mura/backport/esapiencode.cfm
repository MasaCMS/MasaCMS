<cffunction name="esapiEncodeBackport" output="false">
...
<!-- This is done so esapiEncode is not seen when creatig Lucee archives -->
<cfset esapiEncode=esapiEncodeBackport>
