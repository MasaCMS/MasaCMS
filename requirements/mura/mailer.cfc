		...
		<cfloop index="form_element" list="#fields.fieldnames#">
			<cfif form_element neq 'siteid' 
				...
				<cfif findNoCase('attachment',form_element) and isValid("UUID",fields['#form_element#'])>
					...
					<cfset reviewLink='http://#application.settingsManager.getSite(arguments.siteID).getDomain()##variables.configBean.getServerPort()##application.configBean.getContext()#/tasks/render/file/?fileID=#fields["#form_element#"]#&method=attachment' />
