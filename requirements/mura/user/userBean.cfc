...
<cffunction name="getContentTabAssignments" output="false" >
	...
	<cfif it.getRecordcount()>
		<cfloop condition="it.hasNext()">
			...
			<cfelse>
				<cfreturn "Basic,Navigation,Content Objects,List Display Options,Categorization,Tags,Related Content,Extended Attributes,Advanced,Usage Report,SEO,Templates,Publishing"> 
			</cfif>
		</cfloop>
	</cfif>
