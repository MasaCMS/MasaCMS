...
tplugindisplayobjects.location, tplugindisplayobjects.displaymethod, tplugindisplayobjects.docache,tplugindisplayobjects.configurator, configuratorJS
...
<cfargument name="configuratorsOnly" required="true" default="false">
	...
	<cfquery name="rs" dbtype="query">
		...
		<cfelse>
		select pluginID, objectID, moduleID, siteID, name, title, displayObjectfile, docache, directory, displayMethod, configurator, configuratorJS from variables.rsDisplayObjects 
		where siteID=<cfqueryparam cfsqltype="cf_sql_varchar" value="#arguments.siteID#">
		<cfif len(arguments.moduleID)>
		and moduleID=<cfqueryparam cfsqltype="cf_sql_varchar" value="#arguments.moduleID#">
		</cfif>
...
<cfargument name="params" required="true" default="">
	...
	<cfquery name="rs" dbtype="query">
	select pluginID, displayObjectFile,location,displaymethod, docache, objectID, directory, moduleID, configurator, configuratorJS from variables.rsDisplayObjects 
	where 
	...
	group by pluginID, displayObjectFile, location, displaymethod, docache, objectID, directory, moduleID, configurator, configuratorJS
	</cfquery>
