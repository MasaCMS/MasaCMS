...
<cfset variables.instance.excludeSummary=0/>
<cfset variables.instance.excludeBody=0/>
<cfset variables.instance.isActive=1/>
...
<cffunction name="load">
	<cfset var rs=""/>
		...
		isActive,notes,lastUpdate,dateCreated,lastUpdateBy,excludeSummary,excludeBody 
		from tclassextend 
...
<cffunction name="set" output="false" access="public">
		...
		<cfif isquery(arguments.data)>
			...
			<cfset setExcludeSummary(arguments.data.excludeSummary) />
			<cfset setExcludeBody(arguments.data.excludeBody) />
...
<cffunction name="getexcludeSummary" returntype="numeric" access="public" output="false">
	<cfreturn variables.instance.excludeSummary />
</cffunction>

<cffunction name="setexcludeSummary" access="public" output="false">
	<cfargument name="excludeSummary"/>
	<cfif isNumeric(arguments.excludeSummary)>
		<cfset variables.instance.excludeSummary = arguments.excludeSummary />
	</cfif>
	<cfreturn this>
</cffunction>

<cffunction name="getexcludeBody" returntype="numeric" access="public" output="false">
	<cfreturn variables.instance.excludeBody />
</cffunction>

<cffunction name="setexcludeBody" access="public" output="false">
	<cfargument name="excludeBody"/>
	<cfif isNumeric(arguments.excludeBody)>
		<cfset variables.instance.excludeBody = arguments.excludeBody />
	</cfif>
	<cfreturn this>
</cffunction>
...
<cfset var extendSetBean=""/>
	...
	<cfif rs.recordcount>
		...
		excludeSummary = #getExcludeSummary()#,
	...
	<cfelse>
		...
		<cfquery datasource="#variables.configBean.getDatasource()#" username="#variables.configBean.getDBUsername()#" password="#variables.configBean.getDBPassword()#">
		Insert into tclassextend (subTypeID,siteID,type,subType,baseTable,baseKeyField,dataTable,isActive,excludeSummary,excludeBody) 
		values(
