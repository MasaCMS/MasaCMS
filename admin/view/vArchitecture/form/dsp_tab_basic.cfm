...
<cfoutput><textarea name="summary" cols="96" rows="10">#HTMLEditFormat(request.contentBean.getSummary())#</textarea></cfoutput>
</dd>
</cfif>
...
<cfset request.pluginConfig=application.pluginManager.getConfig(rsPluginEditor.pluginID)>
	<cfinclude template="/#application.configBean.getWebRootMap()#/plugins/#rsPluginEditor.directory#/#rsPluginEditor.scriptfile#">
<cfelse>
	<cfscript>
...
<dd>
<input name="moduleAssign" type="CHECKBOX" id="m1" value="00000000000000000000000000000000000" <cfif listFind(request.contentBean.getmoduleAssign(),'00000000000000000000000000000000000')>checked </cfif> class="checkbox"> <label for="m1">#application.rbFactory.getKeyValue(session.rb,'sitemanager.content.fields.sitemanager')#</label>&nbsp;
