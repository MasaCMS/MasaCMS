...
<cfif attributes.locking neq 'all'>
    ...
    <ul>
	   ...
	   <cfswitch expression="#attributes.rsnest.type#">
		...
		<cfcase value="Link">
		<li class="preview"><a title="#application.rbFactory.getKeyValue(session.rb,"sitemanager.view")#" onclick="return preview('#attributes.rsnest.filename#','#attributes.rsnest.targetParams#');">#application.rbFactory.getKeyValue(session.rb,"sitemanager.view")#</a></li>
		</cfcase>
		<cfcase value="File">
