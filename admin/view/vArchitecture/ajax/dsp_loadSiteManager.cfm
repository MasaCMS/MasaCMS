      ...
      <dd class="admin">
          ...
          <cfif not listFindNoCase('none,read',perm)>
            ...
            <cfswitch expression="#request.rsTop.type#">
              ...
              <cfcase value="Link">
              <li class="preview"><a title="#application.rbFactory.getKeyValue(session.rb,"sitemanager.view")#" onclick="return preview('#request.rsTop.filename#','#request.rsTop.targetParams#');">#left(request.rsTop.menutitle,70)#</a></li>
              </cfcase>
              <cfcase value="File">
