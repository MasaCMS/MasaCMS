...
--->
<cfoutput>
	<select name="availableObjects" id="availableObjects" style="width:310px;">
		...
		<cfloop query="request.rslist">
			<option value="feed~#request.rslist.name# - #application.rbFactory.getKeyValue(session.rb,'sitemanager.content.fields.localindex')#~#request.rslist.feedID#">
				#request.rslist.name# 
				- 
