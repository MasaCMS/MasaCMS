...
copySiteID = '#session.copySiteID#';
 ...
 <td class="administration"><ul class="siteSummary five"><cfif not listFindNoCase('none,read',verdict)>
	   ...
	   <cfswitch expression="#request.rsList.type#">
		...
		<cfcase value="Link">
		<li class="preview"><a title="Preview" href="##" onclick="return preview('#request.rsList.filename#','#request.rsList.targetParams#');">#left(request.rsList.menutitle,70)#</a></li>
		</cfcase>
		<cfcase value="File">
