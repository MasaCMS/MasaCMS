...
<form action="index.cfm?fuseaction=cAdvertising.viewReportByPlacement&campaignid=#attributes.campaignid#&userid=#URLEncodedFormat(attributes.userid)#&placementid=#attributes.placementid#&siteid=#URLEncodedFormat(attributes.siteid)#" method="post" name="download" onsubmit="return validate(this);">
