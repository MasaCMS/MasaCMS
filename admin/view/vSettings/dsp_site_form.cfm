  ...
  <!--- Basic --->
    ...
    <dl class="oneColumn">
	 ...
	 <dt>Locale</dt>
      ...
      <dt>Site Caching</dt>
      <dd>		 
       <input type="radio" name="cache" value="0" onchange="if(this.checked){jQuery('##cacheNotice').hide();}else{jQuery('##cacheNotice').show();}" <cfif request.siteBean.getcache() neq 1> CHECKED</CFIF>>
        Off&nbsp;&nbsp;
