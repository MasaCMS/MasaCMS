...
<form novalidate="novalidate" action="index.cfm?fuseaction=cEmail.showAllBounces&siteid=<cfoutput>#attributes.siteid#</cfoutput>" method="post" name="form1" id="filterBounces">
<dl>
<dt>
...
<cfif request.rsBounces.recordcount>
	...
	<form novalidate="novalidate" action="index.cfm?fuseaction=cEmail.deleteBounces&siteid=<cfoutput>#attributes.siteid#</cfoutput>" method="post" name="form2" id="bounces">
