	               ...
	               <cfif session.siteid neq '' and session.mura.isLoggedIn>
	                ...
	                <li id="navHelp" class="dropdown">
	                  ...
	                  <ul class="dropdown-menu">
					   ...
					   <li><a id="navProg-API" href="http://www.getmura.com/component-api/" target="_blank"><i class="icon-bookmark"></i> Component API</a></li>
	 		...
	 		<div class="container">
	 			...
	 			<ul>
	 				...
	 				<cfif listFind(session.mura.memberships,'Admin;#application.settingsManager.getSite(session.siteid).getPrivateUserPoolID()#;0') or listFind(session.mura.memberships,'S2')>
	 					...
	 					<li id="site-config" class="dropdown<cfif listFindNoCase('csettings,cextend,ctrash',rc.originalcircuit) or (rc.moduleID eq '00000000000000000000000000000000000' and rc.originalcircuit eq 'cPerm')> active</cfif>">
