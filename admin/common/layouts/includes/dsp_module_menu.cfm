...
<li class="dropdown<cfif listFind('00000000000000000000000000000000003,0000000000000000000000000000000004',rc.moduleID) or not listFindNoCase('carch,cprivateusers,cpublicusers,cfsetting,cdashboard,ceditprofile,nmessage,cftrash,clogin,cextend',rc.originalcircuit)> active</cfif>">
