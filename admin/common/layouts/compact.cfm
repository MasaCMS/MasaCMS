...
<!--[if gt IE 9]><!--> <html lang="#esapiEncode('html_attr',session.locale)#" class="mura no-focus"><!--<![endif]-->
    ...
    <!-- Favicons -->
	  ...
	  <!-- OneUI Core JS: jQuery, Bootstrap, slimScroll, scrollLock, Appear, CountTo, Placeholder, Cookie and App.js -->
		...
		<!-- CK Editor/Finder -->
		<script type="text/javascript" src="#application.configBean.getContext()#/core/externals/ckeditor/ckeditor.js"></script>
		<script type="text/javascript" src="#application.configBean.getContext()#/core/externals/ckeditor/adapters/jquery.js"></script>

		<cfif rc.$.event('contenttype') neq 'Variation' and not len(rc.$.event('remoteurl')) and not len(rc.$.event('preloadOnly'))>
			<script type="text/javascript" src="#application.configBean.getContext()#/core/externals/ckfinder/ckfinder.js"></script>
		</cfif>

		<!-- Color Picker -->
		<script type="text/javascript" src="#application.configBean.getContext()#/core/externals/colorpicker/js/bootstrap-colorpicker.js?coreversion=#application.coreversion#"></script>
		<link href="#application.configBean.getContext()#/core/externals/colorpicker/css/colorpicker.css?coreversion=#application.coreversion#" rel="stylesheet" type="text/css" />
