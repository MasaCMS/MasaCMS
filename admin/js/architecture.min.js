...
function loadSiteFlat(siteid,moduleid,sortby,sortdirection,startrow)	{
	var url = 'index.cfm';
	var pars = 'fuseaction=cArch.loadSiteFlat&siteid=' + siteid  +  '&moduleid=' + moduleid  + '&sortby=' + sortby  + '&sortdirection=' + sortdirection  + '&startrow=' + startrow + '&cacheid=' + Math.random();
