...
document.getElementById('newZoomLink').onclick=function(){
													...
													loadSiteManager(siteid,contentid,'00000000000000000000000000000000000','','',type,1); 
			...
			//try{
				...
				jQuery(".navReports a").click(
					function(event){
						...
						if(flatViewArgs.report=="lockedfiles" && report!="lockedfiles"){
							flatViewArgs.type="";
						}
						
						flatViewArgs.report=report;
						
						if(flatViewArgs.report=="lockedfiles"){
