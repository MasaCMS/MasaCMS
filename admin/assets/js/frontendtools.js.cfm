		...
		if(targetFrame=='modal'){
			...
			if(ispreview){
				...
				var $tools='<div id="mura-preview-device-selector">';
					...
					$tools=$tools+'<a class="mura-device-phone" title="Phone" data-height="480" data-width="320" data-mobileformat="true"><i class="mi-mobile"></i></a>';
					$tools=$tools+'<a class="mura-device-phone-landscape" title="Phone Landscape" data-height="250" data-width="520" data-mobileformat="true"><i class="mi-mobile mi-rotate-270"></i></a>';
