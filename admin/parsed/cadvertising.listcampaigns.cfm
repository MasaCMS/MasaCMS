...
<!--- fuseaction: listCampaigns --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cAdvertising">
<cfset myFusebox.thisFuseaction = "listCampaigns">
...
<cfset request.rsList = application.advertiserManager.getCampaignsBySiteID(attributes.siteid,attributes.keywords) >
<!--- do action="vAdvertising.listCampaigns" --->
...
<cfif not isDefined("attributes.keywords")><cfset attributes.keywords = "" /></cfif>
<cftry>
<cfoutput><cfinclude template="../view/vAdvertising/dsp_listCampaigns.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 21 and right(cfcatch.MissingFileName,21) is "dsp_listCampaigns.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_listCampaigns.cfm in circuit vAdvertising which does not exist (from fuseaction vAdvertising.listCampaigns).">
