...
<!--- fuseaction: loadExtendedAttributes --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cPublicUsers">
<cfset myFusebox.thisFuseaction = "loadExtendedAttributes">
...
<!--- do action="vPublicUsers.loadExtendedAttributes" --->
...
<cfif not isDefined("request.error")><cfset request.error = "#structnew()#" /></cfif>
<cftry>
<cfoutput><cfinclude template="../view/vPublicUsers/ajax/dsp_extended_attributes.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 32 and right(cfcatch.MissingFileName,32) is "ajax/dsp_extended_attributes.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse ajax/dsp_extended_attributes.cfm in circuit vPublicUsers which does not exist (from fuseaction vPublicUsers.loadExtendedAttributes).">
