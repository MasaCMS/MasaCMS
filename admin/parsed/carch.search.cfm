...
<cfset session.keywords = "#attributes.keywords#" />
...
<cfif not isDefined("attributes.locking")><cfset attributes.locking = "none" /></cfif>
<cftry>
<cfoutput><cfinclude template="../view/vArchitecture/dsp_search.cfm"></cfoutput>
...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_search.cfm in circuit vArch which does not exist (from fuseaction vArch.search).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
