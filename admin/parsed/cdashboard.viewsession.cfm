...
<!--- circuit: cDashboard --->
<!--- fuseaction: viewSession --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cDashboard">
<cfset myFusebox.thisFuseaction = "viewSession">
...
<cfset request.rslist = application.dashboardManager.getSessionHistory(attributes.urlToken,attributes.siteID) >
<!--- do action="vDashboard.viewSession" --->
<cfset myFusebox.thisCircuit = "vDashboard">
<cfsavecontent variable="fusebox.layout">
<cftry>
<cfoutput><cfinclude template="../view/vDashboard/dsp_session.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 15 and right(cfcatch.MissingFileName,15) is "dsp_session.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_session.cfm in circuit vDashboard which does not exist (from fuseaction vDashboard.viewSession).">
