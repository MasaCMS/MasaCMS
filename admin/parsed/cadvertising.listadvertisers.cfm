...
<!--- fuseaction: listAdvertisers --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cAdvertising">
<cfset myFusebox.thisFuseaction = "listAdvertisers">
...
<cfset request.rsList = application.advertiserManager.getAdvertisersBySiteID(attributes.siteid,attributes.keywords) >
<!--- do action="vAdvertising.listAdvertisers" --->
...
<cfif not isDefined("attributes.keywords")><cfset attributes.keywords = "" /></cfif>
<cftry>
<cfoutput><cfinclude template="../view/vAdvertising/dsp_listAdvertisers.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 23 and right(cfcatch.MissingFileName,23) is "dsp_listAdvertisers.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_listAdvertisers.cfm in circuit vAdvertising which does not exist (from fuseaction vAdvertising.listAdvertisers).">
