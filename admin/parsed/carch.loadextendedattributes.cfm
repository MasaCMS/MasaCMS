...
<!--- do action="vArch.loadExtendedAttributes" --->
...
<cftry>
<cfoutput><cfinclude template="../view/vArchitecture/ajax/dsp_extended_attributes.cfm"></cfoutput>
...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse ajax/dsp_extended_attributes.cfm in circuit vArch which does not exist (from fuseaction vArch.loadExtendedAttributes).">
