...
<!--- circuit: cArch --->
<!--- fuseaction: downloaddata --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cArch">
<cfset myFusebox.thisFuseaction = "downloaddata">
...
<cfset request.currentBean = application.contentManager.getActiveContent(attributes.contentid,attributes.siteid) >
<cfset request.dataInfo = application.contentManager.getDownloadselect(attributes.contentid,attributes.siteid) >
...
<cftry>
<cfoutput><cfinclude template="../view/vArchitecture/act_downloaddata.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 20 and right(cfcatch.MissingFileName,20) is "act_downloaddata.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_downloaddata.cfm in circuit vArch which does not exist (from fuseaction vArch.downloaddata).">
