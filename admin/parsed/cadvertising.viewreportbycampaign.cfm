...
<!--- fuseaction: viewReportByCampaign --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cAdvertising">
<cfset myFusebox.thisFuseaction = "viewReportByCampaign">
...
<!--- do action="vAdvertising.viewReportByCampaign" --->
...
<cfif not isDefined("attributes.keywords")><cfset attributes.keywords = "" /></cfif>
<cftry>
<cfoutput><cfinclude template="../view/vAdvertising/dsp_viewReportByCampaign.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 28 and right(cfcatch.MissingFileName,28) is "dsp_viewReportByCampaign.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_viewReportByCampaign.cfm in circuit vAdvertising which does not exist (from fuseaction vAdvertising.viewReportByCampaign).">
