...
<!--- circuit: cEmail --->
<!--- fuseaction: showAllBounces --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cEmail">
<cfset myFusebox.thisFuseaction = "showAllBounces">
...
<cfset request.rsBounces = application.emailManager.getAllBounces(attributes) >
...
<!--- do action="vEmail.showBounces" --->
<cfset myFusebox.thisFuseaction = "showBounces">
...
<cfif not isDefined("session.emaillist.dontshow")><cfset session.emaillist.dontshow = "1" /></cfif>
<cftry>
<cfoutput><cfinclude template="../view/vEmail_Broadcaster/dsp_bounces.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 15 and right(cfcatch.MissingFileName,15) is "dsp_bounces.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_bounces.cfm in circuit vEmail which does not exist (from fuseaction vEmail.showBounces).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
