...
<!--- circuit: cArch --->
<!--- fuseaction: loadCategoryFeatureStartStop --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cArch">
<cfset myFusebox.thisFuseaction = "loadCategoryFeatureStartStop">
...
<!--- do action="vArch.loadCategoryFeatureStartStop" --->
...
<cftry>
<cfoutput><cfinclude template="../view/vArchitecture/ajax/dsp_loadCategoryFeatureStartStop.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 41 and right(cfcatch.MissingFileName,41) is "ajax/dsp_loadCategoryFeatureStartStop.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse ajax/dsp_loadCategoryFeatureStartStop.cfm in circuit vArch which does not exist (from fuseaction vArch.loadCategoryFeatureStartStop).">
