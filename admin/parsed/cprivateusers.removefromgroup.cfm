...
<!--- fuseaction: removefromgroup --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cPrivateUsers">
<cfset myFusebox.thisFuseaction = "removefromgroup">
...
<cfset application.userManager.deleteUserFromGroup(attributes.userid,attributes.groupid) >
