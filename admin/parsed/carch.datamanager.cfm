...
<!--- circuit: cArch --->
<!--- fuseaction: datamanager --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cArch">
<cfset myFusebox.thisFuseaction = "datamanager">
...
<cfif not isDefined("attributes.locking")><cfset attributes.locking = "none" /></cfif>
<cftry>
<cfoutput><cfinclude template="../view/vArchitecture/dsp_data_manager.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 20 and right(cfcatch.MissingFileName,20) is "dsp_data_manager.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_data_manager.cfm in circuit vArch which does not exist (from fuseaction vArch.datamanager).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
