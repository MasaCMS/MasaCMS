...
<!--- circuit: cArch --->
<!--- fuseaction: saveCopyInfo --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cArch">
<cfset myFusebox.thisFuseaction = "saveCopyInfo">
...
<cfset application.contentManager.saveCopyInfo(attributes.siteid,attributes.contentID) >
