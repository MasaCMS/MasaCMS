...
<!--- circuit: cDashboard --->
<!--- fuseaction: listSessions --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cDashboard">
<cfset myFusebox.thisFuseaction = "listSessions">
...
<cfset request.rsList = application.dashboardManager.getSiteSessions(attributes.siteid,attributes.contentid,attributes.membersOnly,attributes.visitorStatus,attributes.span,attributes.spanType) >
<!--- do action="vDashboard.listSessions" --->
<cfset myFusebox.thisCircuit = "vDashboard">
<cfsavecontent variable="fusebox.layout">
<cftry>
<cfoutput><cfinclude template="../view/vDashboard/dsp_listSessions.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 20 and right(cfcatch.MissingFileName,20) is "dsp_listSessions.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_listSessions.cfm in circuit vDashboard which does not exist (from fuseaction vDashboard.listSessions).">
