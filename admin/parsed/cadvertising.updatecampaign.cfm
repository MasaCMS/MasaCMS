...
<!--- fuseaction: updateCampaign --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cAdvertising">
<cfset myFusebox.thisFuseaction = "updateCampaign">
...
<cfset request.campaignBean = application.advertiserManager.updateCampaign(attributes) >
</cfif>
<cfif attributes.action eq 'Delete'>
<cfset application.advertiserManager.deleteCampaign(attributes.campaignid) >
</cfif>
<cfif attributes.action eq 'Add'>
<cfset request.campaignBean = application.advertiserManager.createCampaign(attributes) >
</cfif>
<cfif attributes.action eq 'Add' and structIsEmpty(request.campaignBean.getErrors())>
<cfset attributes.campaignid = "#request.campaignBean.getCampaignID()#" />
</cfif>
<cfif attributes.action eq  'add' or attributes.action neq  'delete' and not structIsEmpty(request.campaignBean.getErrors())>
...
<cfset myFusebox.thisFuseaction = "updateCampaign">
<cfelse>
<cflocation url="index.cfm?fuseaction=cAdvertising.viewAdvertiser&userid=#attributes.userid#&siteid=#attributes.siteid#" addtoken="false">
<cfabort>
</cfif>
