...
<!--- circuit: cArch --->
<!--- fuseaction: exportHtmlSite --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cArch">
<cfset myFusebox.thisFuseaction = "exportHtmlSite">
...
<cfset application.contentManager.exportHtmlSite(attributes.siteid) >
<!--- do action="vArch.exportHtmlSite" --->
...
<cftry>
<cfoutput><cfinclude template="../view/vArchitecture/dsp_export_html_site.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 24 and right(cfcatch.MissingFileName,24) is "dsp_export_html_site.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_export_html_site.cfm in circuit vArch which does not exist (from fuseaction vArch.exportHtmlSite).">
