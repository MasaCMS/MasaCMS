...
<!--- fuseaction: listadzones --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cAdvertising">
<cfset myFusebox.thisFuseaction = "listadzones">
...
<cfset request.rsList = application.advertiserManager.getadzonesBySiteID(attributes.siteid,attributes.keywords) >
<!--- do action="vAdvertising.listadzones" --->
...
<cfif not isDefined("attributes.keywords")><cfset attributes.keywords = "" /></cfif>
<cftry>
<cfoutput><cfinclude template="../view/vAdvertising/dsp_listAdZones.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 19 and right(cfcatch.MissingFileName,19) is "dsp_listAdZones.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_listAdZones.cfm in circuit vAdvertising which does not exist (from fuseaction vAdvertising.listadzones).">
