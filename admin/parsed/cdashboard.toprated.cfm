...
<!--- do action="vDashboard.topRated" --->
<cfset myFusebox.thisCircuit = "vDashboard">
<cfsavecontent variable="fusebox.layout">
<cftry>
<cfoutput><cfinclude template="../view/vDashboard/dsp_topRated.cfm"></cfoutput>
...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_topRated.cfm in circuit vDashboard which does not exist (from fuseaction vDashboard.topRated).">
