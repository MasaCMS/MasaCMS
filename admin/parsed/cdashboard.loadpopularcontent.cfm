...
<!--- circuit: cDashboard --->
<!--- fuseaction: loadPopularContent --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cDashboard">
<cfset myFusebox.thisFuseaction = "loadPopularContent">
...
<!--- do action="vDashboard.loadPopularContent" --->
<cfset myFusebox.thisFuseaction = "loadPopularContent">
<cfsavecontent variable="fusebox.layout">
<cftry>
<cfoutput><cfinclude template="../view/vDashboard/ajax/dsp_popular_content.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 28 and right(cfcatch.MissingFileName,28) is "ajax/dsp_popular_content.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse ajax/dsp_popular_content.cfm in circuit vDashboard which does not exist (from fuseaction vDashboard.loadPopularContent).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
