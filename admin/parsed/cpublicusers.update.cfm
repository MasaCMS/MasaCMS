...
<!--- do action="vPublicUsers.editgroup" --->
...
<cfif not isDefined("request.error")><cfset request.error = "#structnew()#" /></cfif>
<cftry>
<cfoutput><cfinclude template="../view/vPublicUsers/dsp_group.cfm"></cfoutput>
...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_group.cfm in circuit vPublicUsers which does not exist (from fuseaction vPublicUsers.editgroup).">
...
<!--- do action="vPublicUsers.edituser" --->
<cfset myFusebox.thisCircuit = "vPublicUsers">
<cfsavecontent variable="fusebox.layout">
<cfif not isDefined("attributes.Type")><cfset attributes.Type = "0" /></cfif>
<cfif not isDefined("attributes.ContactForm")><cfset attributes.ContactForm = "0" /></cfif>
...
<cfif not isDefined("request.error")><cfset request.error = "#structnew()#" /></cfif>
<cftry>
<cfoutput><cfinclude template="../view/vPublicUsers/dsp_user.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 12 and right(cfcatch.MissingFileName,12) is "dsp_user.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_user.cfm in circuit vPublicUsers which does not exist (from fuseaction vPublicUsers.edituser).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
<!--- do action="layout.display" --->
<cfset myFusebox.thisCircuit = "layout">
