...
<!--- do action="vPublicUsers.editAddress" --->
...
<cfif not isDefined("request.error")><cfset request.error = "#structnew()#" /></cfif>
<cftry>
<cfoutput><cfinclude template="../view/vPublicUsers/dsp_userAddress.cfm"></cfoutput>
...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_userAddress.cfm in circuit vPublicUsers which does not exist (from fuseaction vPublicUsers.editAddress).">
