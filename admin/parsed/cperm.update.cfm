...
<cfset application.permUtility.update(attributes) >
<cflocation url="index.cfm?fuseaction=cArch.list&siteid=#attributes.siteid#&moduleid=#attributes.moduleid#&startrow=#attributes.startrow#&topid=#attributes.topid#" addtoken="false">
<cfabort>
