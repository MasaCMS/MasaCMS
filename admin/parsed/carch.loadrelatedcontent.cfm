...
<!--- circuit: cArch --->
<!--- fuseaction: loadRelatedContent --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cArch">
<cfset myFusebox.thisFuseaction = "loadRelatedContent">
...
<!--- do action="vArch.loadRelatedContent" --->
...
<cftry>
<cfoutput><cfinclude template="../view/vArchitecture/ajax/dsp_loadRelatedContent.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 31 and right(cfcatch.MissingFileName,31) is "ajax/dsp_loadRelatedContent.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse ajax/dsp_loadRelatedContent.cfm in circuit vArch which does not exist (from fuseaction vArch.loadRelatedContent).">
