...
<!--- circuit: cExtend --->
<!--- fuseaction: updateAttribute --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cExtend">
<cfset myFusebox.thisFuseaction = "updateAttribute">
...
<cfset request.attributeBean = application.classExtensionManager.getSubTypeBean().getExtendSetBean().getattributeBean() >
<cfset request.attributeBean.set(attributes) >
<cfif attributes.action eq 'Update'>
<cfset request.attributeBean.save() >
</cfif>
<cfif attributes.action eq 'Delete'>
<cfset request.attributeBean.delete() >
</cfif>
