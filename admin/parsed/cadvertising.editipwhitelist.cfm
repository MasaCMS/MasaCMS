...
<!--- fuseaction: editIPWhiteList --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cAdvertising">
<cfset myFusebox.thisFuseaction = "editIPWhiteList">
...
<cfset request.rsList = application.advertiserManager.getIPWhiteListBySiteID(attributes.siteid) >
<!--- do action="vAdvertising.editIPWhiteList" --->
...
<cfif not isDefined("attributes.keywords")><cfset attributes.keywords = "" /></cfif>
<cftry>
<cfoutput><cfinclude template="../view/vAdvertising/dsp_editIPWhiteList.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 23 and right(cfcatch.MissingFileName,23) is "dsp_editIPWhiteList.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_editIPWhiteList.cfm in circuit vAdvertising which does not exist (from fuseaction vAdvertising.editIPWhiteList).">
