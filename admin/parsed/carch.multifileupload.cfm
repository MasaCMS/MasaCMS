...
<!--- circuit: cArch --->
<!--- fuseaction: multiFileUpload --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cArch">
<cfset myFusebox.thisFuseaction = "multiFileUpload">
...
<!--- do action="vArch.multiFileUpload" --->
<cfset myFusebox.thisFuseaction = "multiFileUpload">
...
<cfif not isDefined("attributes.locking")><cfset attributes.locking = "none" /></cfif>
<cftry>
<cfoutput><cfinclude template="../view/vArchitecture/dsp_multi_upload_form.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 25 and right(cfcatch.MissingFileName,25) is "dsp_multi_upload_form.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_multi_upload_form.cfm in circuit vArch which does not exist (from fuseaction vArch.multiFileUpload).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
<cfset myFusebox.thisCircuit = "cArch">
