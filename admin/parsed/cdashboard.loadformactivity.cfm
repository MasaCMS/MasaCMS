...
<!--- circuit: cDashboard --->
<!--- fuseaction: loadFormActivity --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cDashboard">
<cfset myFusebox.thisFuseaction = "loadFormActivity">
...
<!--- do action="vDashboard.loadFormActivity" --->
<cfset myFusebox.thisFuseaction = "loadFormActivity">
<cfsavecontent variable="fusebox.layout">
<cftry>
<cfoutput><cfinclude template="../view/vDashboard/ajax/dsp_form_activity.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 26 and right(cfcatch.MissingFileName,26) is "ajax/dsp_form_activity.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse ajax/dsp_form_activity.cfm in circuit vDashboard which does not exist (from fuseaction vDashboard.loadFormActivity).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
