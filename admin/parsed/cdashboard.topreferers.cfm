...
<!--- circuit: cDashboard --->
<!--- fuseaction: topReferers --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cDashboard">
<cfset myFusebox.thisFuseaction = "topReferers">
...
<!--- do action="vDashboard.topReferers" --->
<cfset myFusebox.thisCircuit = "vDashboard">
<cfsavecontent variable="fusebox.layout">
<cftry>
<cfoutput><cfinclude template="../view/vDashboard/dsp_topReferers.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 19 and right(cfcatch.MissingFileName,19) is "dsp_topReferers.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_topReferers.cfm in circuit vDashboard which does not exist (from fuseaction vDashboard.topReferers).">
