...
<!--- circuit: cDashboard --->
<!--- fuseaction: topSearches --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cDashboard">
<cfset myFusebox.thisFuseaction = "topSearches">
...
<!--- do action="vDashboard.topSearches" --->
<cfset myFusebox.thisCircuit = "vDashboard">
<cfsavecontent variable="fusebox.layout">
<cftry>
<cfoutput><cfinclude template="../view/vDashboard/dsp_topSearches.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 19 and right(cfcatch.MissingFileName,19) is "dsp_topSearches.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_topSearches.cfm in circuit vDashboard which does not exist (from fuseaction vDashboard.topSearches).">
