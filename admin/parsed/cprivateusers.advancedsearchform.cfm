...
<!--- fuseaction: advancedSearchForm --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cPrivateUsers">
<cfset myFusebox.thisFuseaction = "advancedSearchForm">
...
<!--- do action="vPrivateUsers.advancedSearchForm" --->
...
<cfif not isDefined("request.error")><cfset request.error = "#structnew()#" /></cfif>
<cftry>
<cfoutput><cfinclude template="../view/vPrivateUsers/dsp_advancedSearchForm.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 26 and right(cfcatch.MissingFileName,26) is "dsp_advancedSearchForm.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_advancedSearchForm.cfm in circuit vPrivateUsers which does not exist (from fuseaction vPrivateUsers.advancedSearchForm).">
