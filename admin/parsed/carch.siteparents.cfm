...
<cftry>
<cfoutput><cfinclude template="../view/vArchitecture/ajax/dsp_siteParentsRender.cfm"></cfoutput>
...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse ajax/dsp_siteParentsRender.cfm in circuit vArch which does not exist (from fuseaction vArch.siteParents).">
