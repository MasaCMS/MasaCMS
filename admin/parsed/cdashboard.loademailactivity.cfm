...
<!--- circuit: cDashboard --->
<!--- fuseaction: loadEmailActivity --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "cDashboard">
<cfset myFusebox.thisFuseaction = "loadEmailActivity">
...
<!--- do action="vDashboard.loadEmailActivity" --->
<cfset myFusebox.thisFuseaction = "loadEmailActivity">
<cfsavecontent variable="fusebox.layout">
<cftry>
<cfoutput><cfinclude template="../view/vDashboard/ajax/dsp_email_activity.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 27 and right(cfcatch.MissingFileName,27) is "ajax/dsp_email_activity.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse ajax/dsp_email_activity.cfm in circuit vDashboard which does not exist (from fuseaction vDashboard.loadEmailActivity).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
