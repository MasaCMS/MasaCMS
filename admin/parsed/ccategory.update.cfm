...
<cfset request.categoryBean = application.categoryManager.update(attributes) >
</cfif>
<cfif attributes.action eq 'Delete'>
<cfset application.categoryManager.delete(attributes.categoryid) >
</cfif>
<cfif attributes.action eq 'Add'>
<cfset request.categoryBean = application.categoryManager.create(attributes) >
</cfif>
<cfif attributes.action eq 'Add' and structIsEmpty(request.categoryBean.getErrors())>
<cfset attributes.categoryid = "#request.categoryBean.getCategoryID()#" />
</cfif>
<cfif attributes.action neq  'delete' and not structIsEmpty(request.categoryBean.getErrors())>
