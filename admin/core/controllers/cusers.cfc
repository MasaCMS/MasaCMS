...
component persistent='false' accessors='true' output='false' extends='controller' {
	...
	public any function addToGroup(rc) {
		if ( arguments.rc.$.validateCSRFTokens(context=arguments.rc.userid & arguments.rc.groupid & 'addtogroup') ) {
	...
	public any function updateAddress(rc) {
		if ( arguments.rc.$.validateCSRFTokens(context='updateaddress' & arguments.rc.userid) ) {
			switch(arguments.rc.action) {
				case 'Update' :
