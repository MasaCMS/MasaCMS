...
<cffunction name="before" output="false">
	...
	<cfif not (isdefined("arguments.rc.baseID") and listLast(arguments.rc.muraAction,":") eq "cPublicUsers.loadExtendedAttributes" and arguments.rc.baseID eq session.mura.userID)>
