...
--->
	...
	<cfelse>
		...
		<script>
			var hasMuraLoader=(typeof Mura != 'undefined' && (typeof Mura.loader != 'undefined' || typeof root.queuedMuraCmds != 'undefined'));
			if(!window.CKEDITOR){
				if(hasMuraLoader){
					Mura(function(){
						Mura.loader().loadjs(
			...
			if(!window.CKFinder){
				if(hasMuraLoader){
					Mura(function(){
						Mura.loader().loadjs('#variables.$.globalConfig("requirementsPath")#/ckfinder/ckfinder.js');
					});
				} else {
