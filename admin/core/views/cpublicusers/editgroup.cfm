...
<cfswitch expression="#rc.userBean.getperm()#">
    ...
    <cfoutput>
     ...
     <form novalidate="novalidate"<cfif not (rsSubTypes.recordcount or arrayLen(pluginEventMappings))> class="fieldset-wrap"</cfif> action="./?muraAction=cPublicUsers.update&userid=#tempEncodeForURL(rc.userBean.getUserID())#" enctype="multipart/form-data" method="post" name="form1" onsubmit="return validate(this);">
      </cfoutput>
 ...
 <cfif rc.userid neq ''>
      ...
      <h2>#application.rbFactory.getKeyValue(session.rb,'user.groupmembers')#</h2> 
        ...
        <tr> 
                <td class="var-width"><a href="./?muraAction=#iif(rc.rsgrouplist.isPublic,de('cPublicUsers'),de('cPrivateUsers'))#.edituser&userid=#rc.rsgrouplist.UserID#&routeid=#rc.userid#&siteid=#tempEncodeForURL(rc.siteid)#">#tempEncodeForHTML(rc.rsgrouplist.lname)#, #tempEncodeForHTML(rc.rsgrouplist.fname)# <cfif rc.rsgrouplist.company neq ''> (#tempEncodeForHTML(rc.rsgrouplist.company)#)</cfif></a></td>
        ...
        <td>#LSTimeFormat(rc.rsgrouplist.lastupdate,"short")#</td>
              <td>#rc.rsgrouplist.LastUpdateBy#</td>
                <td class="actions"><ul class="group"><li class="edit"><a href="./?muraAction=#iif(rc.rsgrouplist.isPublic,de('cPublicUsers'),de('cPrivateUsers'))#.edituser&userid=#rc.rsgrouplist.UserID#&routeid=#rc.userid#&siteid=#tempEncodeForURL(rc.siteid)#"><i class="icon-pencil"></i></a></li><li class="delete"><a href="./?muraAction=cPublicUsers.removefromgroup&userid=#rc.rsgrouplist.UserID#&routeid=#rc.userid#&groupid=#rc.userid#&siteid=#tempEncodeForURL(rc.siteid)#" onclick="return confirmDialog('#tempEncodeForJavascript(application.rbFactory.getKeyValue(session.rb,'user.removeconfirm'))#',this.href)"><i class="icon-remove-sign"></i></a></li></ul></td>
              </tr>
            </cfoutput> 
  ...
  <cfif rc.nextN.numberofpages gt 1> 
    ...
    <ul>
      <cfif rc.nextN.currentpagenumber gt 1>
        <li>
       <a href="./?muraAction=cPublicUsers.editgroup&startrow=#rc.nextN.previous#&userid=#tempEncodeForURL(rc.userid)#&siteid=#tempEncodeForURL(rc.siteid)#">&laquo;&nbsp;#application.rbFactory.getKeyValue(session.rb,'user.prev')#</a>
       </li> 
      </cfif>
      ...
      <cfelse> 
        <li>
        <a href="./?muraAction=cPublicUsers.editgroup&startrow=#evaluate('(#i#*#rc.nextN.recordsperpage#)-#rc.nextN.recordsperpage#+1')#&userid=#tempEncodeForURL(rc.userid)#&siteid=#tempEncodeForURL(rc.siteid)#">#i#</a> 
        </li>
      </cfif></cfloop>
            <cfif rc.nextN.currentpagenumber lt rc.nextN.NumberOfPages>
      <li>
      <a href="./?muraAction=cPublicUsers.editgroup&startrow=#rc.nextN.next#&userid=#tempEncodeForURL(rc.userid)#&siteid=#tempEncodeForURL(rc.siteid)#">#application.rbFactory.getKeyValue(session.rb,'user.next')#&nbsp;&raquo;</a> 
      </li>
      </cfif>
    </ul>
    </div>
