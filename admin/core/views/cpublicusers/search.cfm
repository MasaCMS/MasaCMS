        ...
        <table class="mura-table-grid">
          ...
          <cfif rc.rsList.recordcount>
            <cfoutput query="rc.rsList" maxrows="#rc.nextN.recordsperPage#" startrow="#rc.startrow#"> 
              <tr> 
                <td class="var-width"><a title="Edit" href="./?muraAction=cPublicUsers.edituser&userid=#rc.rsList.UserID#&type=2&siteid=#esapiEncode('url',rc.siteid)#&returnURL=#esapiEncode('url',rc.currentURL)#">#esapiEncode('html',rc.rsList.lname)#, #esapiEncode('html',rc.rsList.fname)# <cfif company neq ''> (#esapiEncode('html',company)#)</cfif></a></td>
			  ...
			  <td>#esapiEncode('html',rc.rsList.LastUpdateBy)#</td>
                <td class="actions"><ul><li class="edit"><a title="#application.rbFactory.getKeyValue(session.rb,'user.edit')#" href="./?muraAction=cPublicUsers.edituser&userid=#rc.rsList.UserID#&type=2&siteid=#esapiEncode('url',rc.siteid)#&returnURL=#esapiEncode('url',rc.currentURL)#"><i class="icon-pencil"></i></a></li></ul></td>
              </tr>
            </cfoutput>
...
<cfset args=arrayNew(1)>
    ...
    <div class="pagination">
		...
		<cfif rc.nextN.currentpagenumber gt 1> 
		  <li>
		    <a href="./?muraAction=cPublicUsers.search&startrow=#rc.nextN.previous#&lname=#esapiEncode('url',rc.lname)#&siteid=#esapiEncode('url',rc.siteid)#&search=#esapiEncode('url',rc.search)#">&laquo;&nbsp;#application.rbFactory.getKeyValue(session.rb,'user.prev')#</a>
		  </li>
		</cfif>	
		 <cfloop from="#rc.nextN.firstPage#"  to="#rc.nextN.lastPage#" index="i">
		  ...
		  <cfelse> 
		    <li><a href="./?muraAction=cPublicUsers.search&startrow=#evaluate('(#i#*#rc.nextN.recordsperpage#)-#rc.nextN.recordsperpage#+1')#&lname=#esapiEncode('url',rc.lname)#&siteid=#esapiEncode('url',rc.siteid)#&search=#esapiEncode('url',rc.search)#">#i#</a></li>
		  </cfif>
		</cfloop>
		<cfif rc.nextN.currentpagenumber lt rc.nextN.NumberOfPages>
		  <li><a href="./?muraAction=cPublicUsers.search&startrow=#rc.nextN.next#&lname=#esapiEncode('url',rc.lname)#&siteid=#esapiEncode('url',rc.siteid)#&search=#esapiEncode('url',rc.search)#">#application.rbFactory.getKeyValue(session.rb,'user.next')#&nbsp;&raquo;</a>
		  </li>
		</cfif> 
		</ul>
    </div>
