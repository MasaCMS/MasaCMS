...
<form class="fieldset-wrap" novalidate="novalidate" action="./?muraAction=cAdvertising.updateCreative&siteid=#tempEncodeForURL(rc.siteid)#&userid=#tempEncodeForURL(rc.userid)#" enctype="multipart/form-data" method="post" name="form1" onsubmit="return validate(this);">
<div class="fieldset">
<div class="control-group">
	...
	<div class="controls">
		<input name="name" type="text" class="text" required="true" message="#application.rbFactory.getKeyValue(session.rb,'advertising.namerequired')#" value="#tempEncodeForHTMLAttribute(rc.creativeBean.getName())#" maxlength="50">
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls"><textarea name="textBody" id="textBody" class="textArea htmlEditor">#tempEncodeForHTML(rc.creativeBean.getTextBody())#</textarea>
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls"><input name="title" type="text" class="text"  value="#tempEncodeForHTMLAttribute(rc.creativeBean.getTitle())#" maxlength="200">
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls"><input name="linkTitle" type="text" class="text"  value="#tempEncodeForHTMLAttribute(rc.creativeBean.getLinkTitle())#" maxlength="100">
	</div>
</div>
</span>
...
<div class="control-group">
	...
	<div class="controls">
		<input name="height" type="text" validate="numeric" class="text" message="#application.rbFactory.getKeyValue(session.rb,'advertising.heightvalidate')#" value="#rc.creativeBean.getHeight()#">
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls">
	<input name="width" type="text" validate="numeric" class="text" message="#application.rbFactory.getKeyValue(session.rb,'advertising.widthvalidate')#" value="#rc.creativeBean.getWidth()#">
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls">
		<input name="redirectURL" type="text" class="text" value="#tempEncodeForHTMLAttribute(rc.creativeBean.getRedirectURL())#" maxlength="200">
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls"><input name="altText" type="text" class="text"  value="#tempEncodeForHTMLAttribute(rc.creativeBean.getAltText())#" maxlength="200">
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls">
		<input name="isActive" class="radio inline" type="radio" value="1" <cfif rc.creativeBean.getIsActive()>checked</cfif>>#application.rbFactory.getKeyValue(session.rb,'advertising.yes')# 
		<input name="isActive" class="radio inline" type="radio" value="0" <cfif not rc.creativeBean.getIsActive()>checked</cfif>>#application.rbFactory.getKeyValue(session.rb,'advertising.no')# 
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls"><textarea name="notes" class="textArea">#tempEncodeForHTML(rc.creativeBean.getNotes())#</textarea>
	</div>
</div>
</div>
...
<cfelse> 
	<input type="button" class="submit btn btn-delete" onclick="submitForm(document.forms.form1,'delete','#tempEncodeForJavascript(application.rbFactory.getKeyValue(session.rb,'advertising.deletecreativeconfirm'))#');" value="#application.rbFactory.getKeyValue(session.rb,'advertising.delete')#" />
