...
<cfoutput query="rc.rsList">
	<tr>
		<td class="var-width"><a title="#application.rbFactory.getKeyValue(session.rb,'advertising.edit')#" href="./?muraAction=cAdvertising.editCreative&userid=#rc.rslist.userid#&siteid=#encodeForURL(rc.siteid)#&creativeid=#rc.rslist.creativeID#">#rc.rslist.name#</a></td>
		...
		<li class="edit"><a title="#application.rbFactory.getKeyValue(session.rb,'advertising.edit')#" href="./?muraAction=cAdvertising.editCreative&userid=#rc.rslist.userid#&siteid=#encodeForURL(rc.siteid)#&creativeid=#rc.rslist.creativeID#"><i class="icon-pencil"></i></a></li></ul>
		</td></tr>
</cfoutput>
<cfelse>
<tr>
