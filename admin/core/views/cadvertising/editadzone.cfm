...
<form <cfif rc.adZoneID eq ''>class="fieldset-wrap"</cfif> novalidate="novalidate" name="form1" method="post" action="./?muraAction=cAdvertising.updateAdZone&siteid=#esapiEncode('url',rc.siteid)#" onsubmit="return false;">
	...
	<div class="tab-content">
		...
		<div class="fieldset">
			<div class="control-group">
				...
				<div class="controls">
					<input name="name" type="text" class="text" required="true" message="#application.rbFactory.getKeyValue(session.rb,'advertising.namerequired')#" value="#esapiEncode('html_attr',rc.adZoneBean.getName())#" maxlength="50">
				</div>
			</div><!--- // Name --->
			...
			<div class="control-group">
				...
				<div class="controls">
				<textarea name="notes" class="textArea">#esapiEncode('html',rc.adZoneBean.getNotes())#</textarea>
				</div>
			</div><!--- // Notes --->
		...
		<div class="form-actions">
			...
			<cfelse>
				<input type="button" class="btn" onclick="submitForm(document.forms.form1,'delete','#esapiEncode('javascript',application.rbFactory.getKeyValue(session.rb,'advertising.deleteadzoneconfirm'))#');" value="#application.rbFactory.getKeyValue(session.rb,'advertising.delete')#" />
