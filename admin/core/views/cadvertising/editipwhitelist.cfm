...
<form class="fieldset-wrap" novalidate="novalidate" name="form1" method="post" action="./?muraAction=cAdvertising.updateIPWhiteList&siteid=#URLEncodedFormat(rc.siteid)#">
<div class="fieldset">
...
<input type="button" class="btn" onclick="document.form1.submit();" value="#application.rbFactory.getKeyValue(session.rb,'advertising.update')#" />
</div>
</form>
</cfoutput>