...
<form class="fieldset-wrap" novalidate="novalidate" name="form1" method="post" action="./?muraAction=cAdvertising.updateIPWhiteList&siteid=#esapiEncode('url',rc.siteid)#">
<div class="fieldset">
