...
<li><a href="./?muraAction=cAdvertising.editAdZone&adzoneid=&siteid=#esapiEncode('url',rc.siteid)#"><i class="icon-plus-sign"></i> #application.rbFactory.getKeyValue(session.rb,'advertising.addnewadzone')#</a></li>
</ul>
...
<cfoutput query="rc.rslist">
	<tr>
		<td class="var-width"><a title="#application.rbFactory.getKeyValue(session.rb,'advertising.edit')#" href="./?muraAction=cAdvertising.editAdZone&adZoneid=#rc.rslist.adzoneid#&siteid=#esapiEncode('url',rc.siteid)#">#name#</a></td>
		<td>#creativeType#</td>
		<td>#height#</td>
		<td>#width#</td>
	<td>
		...
		<td class="actions"><ul>
		<li class="edit"><a title="#application.rbFactory.getKeyValue(session.rb,'advertising.edit')#" href="./?muraAction=cAdvertising.editAdZone&adZoneid=#rc.rslist.adzoneid#&siteid=#esapiEncode('url',rc.siteid)#"><i class="icon-pencil"></i></a></li>
		<li class="delete"><a title="#application.rbFactory.getKeyValue(session.rb,'advertising.delte')#" href="./?muraAction=cAdvertising.updateAdZone&action=delete&adzoneid=#rc.rslist.adZoneid#&siteid=#esapiEncode('url',rc.siteid)#" onclick="return confirmDialog('#esapiEncode('javascript',application.rbFactory.getKeyValue(session.rb,'advertising.deleteadzoneconfirm'))#',this.href)"><i class="icon-remove-sign"></i></a></li></ul>
		</td></tr>
</cfoutput>
<cfelse>
<tr>
