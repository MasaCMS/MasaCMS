...
<li><a href="./?muraAction=cPublicUsers.editUser&userid=&siteid=#tempEncodeForURL(rc.siteid)#&groupid=#application.advertiserManager.getGroupID(rc.siteid)#&routeid=adManager">Add Advertiser</li>
</ul> --->
...
<cfoutput query="rc.rslist">
	<tr>
		<td class="var-width"><a title="#application.rbFactory.getKeyValue(session.rb,'advertising.edit')#" href="./?muraAction=cAdvertising.viewAdvertiser&userid=#rc.rslist.userid#&siteid=#tempEncodeForURL(rc.siteid)#">#company#</a></td>
		<td>#fname# #lname#</td>
		<td><cfif email neq ''><a href="mailto:#email#">#email#</a><cfelse>&nbsp;</cfif></td>
		<td class="actions"><ul class="advertisers"><li class="edit"><a title="#application.rbFactory.getKeyValue(session.rb,'advertising.edit')#" href="./?muraAction=cAdvertising.viewAdvertiser&userid=#rc.rslist.userid#&siteid=#tempEncodeForURL(rc.siteid)#"><i class="icon-pencil"></i></a></li></ul></td></tr>
</cfoutput>
<cfelse>
<tr>
