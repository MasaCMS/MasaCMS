...
<form novalidate="novalidate" action="./?muraAction=cAdvertising.viewReportByPlacement&campaignid=#rc.campaignid#&userid=#tempEncodeForURL(rc.userid)#&placementid=#rc.placementid#&siteid=#tempEncodeForURL(rc.siteid)#" method="post" name="download" onsubmit="return validate(this);">
