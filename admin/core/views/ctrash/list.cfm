...
<div class="mura-header">
 ...
 <div class="nav-module-specific btn-group">
	...
	<a class="btn" href="./?muraAction=cTrash.empty&siteID=#esapiEncode('url',rc.siteID)#&sinceDate=#esapiEncode('html_attr',$.event('sinceDate'))#&beforeDate=#esapiEncode('html_attr',$.event('beforeDate'))##rc.$.renderCSRFTokens(context='emptytrash' & rc.siteID, format='url')#" onclick="return confirmDialog('Empty Site Trash?', this.href);"><i class="mi-trash"></i>Empty Trash</a>
 </div>
