...
<cf_dsp_categories_nest siteID="#rc.siteID#" parentID="#rslist.categoryID#" categoryID="#rc.categoryID#" nestLevel="#val(rc.nestLevel +1)#" extendSetBean="#rc.extendSetBean#">
</li>
</cfoutput>
</ul>
</cfif>
