...
<h2><i class="#application.settingsManager.getSite(rc.siteID).getContentRenderer(type=subType.getType(),subtype=subType.getSubType()).iconClassByContentType(type=subType.getType())#"></i> #application.classExtensionManager.getTypeAsString(subType.getType())#/#subType.getSubType()#</h2>
