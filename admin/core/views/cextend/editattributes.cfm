...
<div id="nav-module-specific" class="btn-group">
	<div class="btn-group">
      <a class="btn dropdown-toggle" data-toggle="dropdown" href="##">
       ...
       <ul class="dropdown-menu">
          <li><a href="./?muraAction=cExtend.editSubType&subTypeID=#encodeForURL(rc.subTypeID)#&siteid=#encodeForURL(rc.siteid)#">Class Extension</a></li>
          <li><a href="./?muraAction=cExtend.editSet&subTypeID=#encodeForURL(rc.subTypeID)#&extendSetID=#encodeForURL(rc.extendSetID)#&siteid=#encodeForURL(rc.siteid)#">Attribute Set</a></li>
       </ul>
       </div>
</div>
...
<cfoutput>
	<li test attributeID="#attributeBean.getAttributeID()#">
		...
		<a title="Delete" href="./?muraAction=cExtend.updateAttribute&action=delete&subTypeID=#encodeForURL(rc.subTypeID)#&extendSetID=#attributeBean.getExtendSetID()#&siteid=#encodeForURL(rc.siteid)#&attributeID=#attributeBean.getAttributeID()##rc.$.renderCSRFTokens(context=attributeBean.getAttributeID(),format='url')#" onClick="return confirmDialog('Delete the attribute #encodeForJavascript("'#attributeBean.getname()#'")#?',this.href)"><i class="icon-remove-sign"></i></a>
		</div>
