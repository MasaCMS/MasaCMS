        ...
        <cfif rc.rsplugins.recordcount>
          <cfloop query="rc.rsplugins">
              <label class="checkbox">
                ...
                #tempEncodeForHTML(rc.rsplugins.name)#</label>
          </cfloop>
          <cfelse>
      ...
      <div class="controls">
        <p class="help-block">
         ...
         <p class="help-block">Current Working Directory:#application.configBean.getWebRoot()##application.configBean.getFileDelim()#admin#application.configBean.getFileDelim()#temp</p>
          <input type="button" class="btn" onclick="jQuery('##saveFileDir').val('#tempEncodeForJavascript('#application.configBean.getWebRoot()##application.configBean.getFileDelim()#admin#application.configBean.getFileDelim()#temp')#');" value="Select this Directory">
