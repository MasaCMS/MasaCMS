 ...
 <div id="custom-image-form" data-sizeid="#rc.customImage.getSizeID()#" class="fieldset-wrap row-fluid">
	 <div class="fieldset">
      	<div class="control-group">
            ...
            <div class="controls">
                <input id="custom-image-name" type="text" class="span12" value="#tempEncodeForHTMLAttribute(rc.customImage.getName())#"  onchange="removePunctuation(this);" maxlength="50"/>
             </div>
        </div>
         <div class="control-group">
