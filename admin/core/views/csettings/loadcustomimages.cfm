...
<tr>
<td class="var-width">#tempEncodeForHTML(image.getName())#</td>
<td>#tempEncodeForHTML(image.getHeight())#</td>
<td>#tempEncodeForHTML(image.getWidth())#</td>
<td class="actions"><ul>
	<li class="edit"><a href="##" text="Edit" onclick="return openCustomImageSize('#image.getSizeID()#','#tempEncodeForJavascript(image.getSiteID())#');"><i class="icon-pencil"></i></a></li>
</ul></td>
</tr>
</cfloop>
</table>
