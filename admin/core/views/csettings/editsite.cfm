...
<cfoutput>
  <cfif len(rc.siteid)>
    <div id="nav-module-specific" class="btn-group"> <a class="btn" href="./?muraAction=cExtend.listSubTypes&siteid=#encodeForURL(rc.siteid)#"><i class="icon-list-alt"></i> Class Extension Manager</a> <a  class="btn" href="./?muraAction=cTrash.list&siteID=#encodeForURL(rc.siteid)#"><i class="icon-trash"></i> Trash Bin</a>
      <cfif rc.action eq "updateFiles">
        <a href="./?muraAction=cSettings.editSite&siteid=#encodeForURL(rc.siteid)#"><i class="icon-pencil"></i> Edit Site</a>
        <cfelseif application.configBean.getAllowAutoUpdates() and  listFind(session.mura.memberships,'S2')>
        <a  class="btn" href="##" onclick="confirmDialog('WARNING: Do not update your site files unless you have backed up your current siteID directory.',function(){actionModal('./?muraAction=cSettings.editSite&siteid=#encodeForURL(rc.siteid)#&action=updateFiles#rc.$.renderCSRFTokens(context=rc.siteid & 'updatesite',format='url')#')});return false;"><i class="icon-bolt"></i> Update Site Files to Latest Version</a> 
      </cfif>
      <a  class="btn" href="?muraAction=cSettings.selectBundleOptions&siteID=#encodeForURL(rc.siteBean.getSiteID())#"><i class="icon-gift"></i> Create Site Bundle</a>
      <cfif len(rc.siteBean.getExportLocation()) and directoryExists(rc.siteBean.getExportLocation())>
        <a  class="btn" href="##"  onclick="confirmDialog('Export static HTML files to #encodeForJavascript("'#rc.siteBean.getExportLocation()#'")#.',function(){actionModal('./?muraAction=csettings.exportHTML&siteID=#rc.siteBean.getSiteID()#')});return false;"><i class="icon-share"></i> Export Static HTML (BETA)</a>
      </cfif>
    </div>
  </cfif>
</cfoutput>
 ...
 --->
    ...
    <div id="tabBasic" class="tab-pane fade">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input name="site" type="text" class="span12"  value="#encodeForHTMLAttribute(rc.siteBean.getsite())#" size="50" maxlength="50">
              </div>
          </div>
          </div>
        <div class="control-group">
            ...
            <div class="controls">
            <input name="tagline" type="text" class="span12"  value="#encodeForHTMLAttribute(rc.siteBean.getTagline())#" size="50" maxlength="255">
          </div>
          </div>
        <div class="control-group">
            <div class="span6">
            ...
            <div class="controls">
                <input name="domain" type="text" class="span12"  value="#encodeForHTMLAttribute(rc.siteBean.getdomain('production'))#" size="50" maxlength="255">
              </div>
...
--->
            ...
            <div class="controls">
                <textarea rows="6" class="span12" name="domainAlias" rows="6" class="span12" >#encodeForHTML(rc.siteBean.getDomainAlias())#</textarea>
              </div>
          </div>
          </div>
        <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input name="pagelimit" type="text" class="span12"  value="#encodeForHTMLAttribute(rc.siteBean.getpagelimit())#" size="5" maxlength="6">
              </div>
          </div>
            <div class="span6">
            <label class="control-label">Default  Rows <span>(in Site Manager)</span></label>
            <div class="controls">
                <input name="nextN" type="text" class="span12"  value="#encodeForHTMLAttribute(rc.siteBean.getnextN())#" size="5" maxlength="5">
              </div>
          </div>
          </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input name="cacheCapacity" type="text" class="span3" value="#encodeForHTMLAttribute(rc.siteBean.getCacheCapacity())#" size="15" maxlength="15">
              </div>
          </div>--->
            <div class="span6">
            <label class="control-label">Cache Free Memory Threshold <span class="help-inline">(Defaults to 60%)</span></label>
            <div class="controls">
                <input name="cacheFreeMemoryThreshold" type="text" class="span2" value="#encodeForHTMLAttribute(rc.siteBean.getCacheFreeMemoryThreshold())#" size="3" maxlength="3">
                % </div>
          </div>
          </div>
        <div class="control-group">
	    ...
	    <div class="fieldset">
	        <div class="control-group">
		        <div class="span6">
		            ...
		            <div class="controls">
		            	<input name="contactName" type="text" class="span12"  value="#encodeForHTMLAttribute(rc.siteBean.getcontactName())#" size="50" maxlength="50" maxlength="100">
		            </div>
		        </div>
		        ...
		        <div class="span6">
		            ...
		            <div class="controls">
		            	<input name="contactAddress" type="text" class="span12"  value="#encodeForHTMLAttribute(rc.siteBean.getcontactAddress())#" size="50" maxlength="50" maxlength="100">
		            </div>
		        </div>          
	        </div>
	        ...
	        <div class="control-group">
		        <div class="span6">
		            ...
		            <div class="controls">
		            	<input name="contactCity" type="text" class="span12"  value="#encodeForHTMLAttribute(rc.siteBean.getcontactCity())#" size="50" maxlength="50" maxlength="100">
		            </div>
	            </div>
		        ...
		        <div class="span2">
		            ...
		            <div class="controls">
		            	<input name="contactState" type="text" class="span12"  value="#encodeForHTMLAttribute(rc.siteBean.getcontactState())#" size="50" maxlength="50" maxlength="100">
		            </div>
	            </div>
		        ...
		        <div class="span4">
		            ...
		            <div class="controls">
		            	<input name="contactZip" type="text" class="span12"  value="#encodeForHTMLAttribute(rc.siteBean.getcontactZip())#" size="50" maxlength="50" maxlength="100">
		            </div>
	            </div>
            </div>
	        ...
	        <div class="control-group">
		        <div class="span6">
		            ...
		            <div class="controls">
		            <input name="contactPhone" type="text" class="span12"  value="#encodeForHTMLAttribute(rc.siteBean.getcontactPhone())#" size="50" maxlength="50" maxlength="100">
		            </div>
		        </div>
	        ...
	        <div class="span6">
	            ...
	            <div class="controls">
	            <input name="contactEmail" type="text" class="span12"  value="#encodeForHTMLAttribute(rc.siteBean.getcontactEmail())#" size="50" maxlength="50" maxlength="100">
	            </div>
	        </div>
    ...
    <div id="tabSharedresources" class="tab-pane fade">
        ...
        <div class="span3">
	        ...
	        <div class="controls">
	            ...
	            <cfloop query="rsSites">
	                ...
	                <option value="#rsSites.siteid#" <cfif rsSites.siteid eq rc.siteBean.getPublicUserPoolID()>selected</cfif>>#encodeForHTML(rsSites.site)#</option>
	              </cfif>
	              </cfloop>
	          </select>
	          </div>
        ...
        <div class="controls">
            ...
            <cfloop query="rsSites">
                <cfif rsSites.siteid neq rc.siteBean.getSiteID()>
                <option value="#rsSites.siteid#" <cfif rsSites.siteid eq rc.siteBean.getPrivateUserPoolID()>selected</cfif>>#encodeForHTML(rsSites.site)#</option>
              </cfif>
              </cfloop>
          </select>
          </div>
        ...
        <div class="controls">
            ...
            <cfloop query="rsSites">
                <cfif rsSites.siteid neq rc.siteBean.getSiteID()>
                <option value="#rsSites.siteid#" <cfif rsSites.siteid eq rc.siteBean.getAdvertiserUserPoolID()>selected</cfif>>#encodeForHTML(rsSites.site)#</option>
              </cfif>
              </cfloop>
          </select>
          </div>
        ...
        <div class="controls">
            ...
            <cfloop query="rsSites">
                <cfif rsSites.siteid neq rc.siteBean.getSiteID()>
                <option value="#rsSites.siteid#" <cfif rsSites.siteid eq rc.siteBean.getDisplayPoolID()>selected</cfif>>#encodeForHTML(rsSites.site)#</option>
              </cfif>
              </cfloop>
          </select>
          </div>
        ...
        <div class="controls">
            ...
            <cfloop query="rsSites">
                <cfif rsSites.siteid neq rc.siteBean.getSiteID()>
                <option value="#rsSites.siteid#" <cfif rsSites.siteid eq rc.siteBean.getFilePoolID()>selected</cfif>>#encodeForHTML(rsSites.site)#</option>
              </cfif>
              </cfloop>
          </select>
          </div>
          ...
          <cfif application.configBean.getEmailBroadcaster()>
	        <div class="control-group">
		        ...
		        <div class="span3">
			        ...
			        <div class="controls">
			            <input name="EmailBroadcasterLimit" type="text" class="span4" value="#encodeForHTMLAttribute(rc.siteBean.getEmailBroadcasterLimit())#" size="50" maxlength="50">
			        </div>
			      </div>
    ...
    <div id="tabEmail" class="tab-pane fade">
        ...
        <div class="controls">
            <input name="contact" type="text" class="span8" value="#encodeForHTMLAttribute(rc.siteBean.getcontact())#" size="50" maxlength="50">
          </div>
      </div>
        <div class="control-group">
        <div class="span4">
        ...
        <div class="controls">
            <input name="MailServerIP" type="text" class="text" value="#encodeForHTMLAttribute(rc.siteBean.getMailServerIP())#" size="50" maxlength="50">
          </div>
      </div>
        <div class="span4">
        <label class="control-label">Mail Server SMTP Port</label>
        <div class="controls">
            <input name="MailServerSMTPPort" type="text" class="text" value="#encodeForHTMLAttribute(rc.siteBean.getMailServerSMTPPort())#" size="5" maxlength="5">
          </div>
      </div>
        <div class="span4">
        <label class="control-label">Mail Server POP Port</label>
        <div class="controls">
            <input name="MailServerPOPPort" type="text" class="text" value="#encodeForHTMLAttribute(rc.siteBean.getMailServerPOPPort())#" size="5" maxlength="5">
          </div>
      </div>
        </div>
        ...
        <div class="controls">
            <input name="MailServerUserName" type="text" class="span12" value="#encodeForHTMLAttribute(rc.siteBean.getMailServerUserName())#" size="50" maxlength="50">
          </div>
      </div>
        <div class="span6">
        <label class="control-label">Mail Server Password</label>
        <div class="controls">
            <input name="MailServerPassword" type="text" class="span12" value="#encodeForHTMLAttribute(rc.siteBean.getMailServerPassword())#" size="50" maxlength="50">
          </div>
      </div>
        </div>
       ...
       <div class="control-group">
        ...
        <div class="controls">
            ...
            <textarea rows="6" class="span12" name="contentApprovalScript">#encodeForHTML(rc.siteBean.getContentApprovalScript())#</textarea>
          </div>
      </div>
       ...
       <div class="control-group">
        ...
        <div class="controls">
            <p class="help-block">Available Dynamic Content: ##returnURL## ##contentName## ##parentName## ##contentType##</p>
            <textarea rows="6" class="span12" name="contentRejectionScript">#encodeForHTML(rc.siteBean.getContentRejectionScript())#</textarea>
          </div>
      </div>
        ...
        <div class="controls">
            ...
            <textarea rows="6" class="span12" name="sendLoginScript">#encodeForHTML(rc.siteBean.getSendLoginScript())#</textarea>
          </div>
      </div>
        <div class="control-group">
        ...
        <div class="controls">
            ...
            <textarea rows="6" class="span12" name="mailingListConfirmScript">#encodeForHTML(rc.siteBean.getMailingListConfirmScript())#</textarea>
          </div>
      </div>
        <div class="control-group">
        ...
        <div class="controls">
            ...
            <textarea rows="6" class="span12" name="accountActivationScript">#encodeForHTML(rc.siteBean.getAccountActivationScript())#</textarea>
          </div>
      </div>
      <!---
        <div class="control-group">
        ...
        <div class="controls">
            <p class="help-block">Available Dynamic Content: ##returnURL## ##contentName## ##parentName## ##contentType##</p>
            <textarea rows="6" class="span12" name="publicSubmissionApprovalScript">#encodeForHTML(rc.siteBean.getPublicSubmissionApprovalScript())#</textarea>
          </div>
      </div>
      --->
        <div class="control-group">
        ...
        <div class="controls">
            ...
            <textarea rows="6" class="span12" name="reminderScript">#encodeForHTML(rc.siteBean.getReminderScript())#</textarea>
          </div>
      </div>
    ...
    function deleteCustomImageSize(){
     ...
     $(document).ready(function(){loadCustomImages({siteid:'#encodeForJavascript(rc.siteBean.getSiteID())#'})});

      </script>
      <div class="control-group">
        <label class="control-label">Custom Images</label>
        <ul class="nav nav-pills"><li><a href="##" onclick="return openCustomImageSize('','#encodeForJavascript(rc.siteBean.getSiteID())#')"><i class="icon-plus-sign"></i> Add Custom Image Size</a></li></ul>
    ...
    <div id="tabExtranet" class="tab-pane fade">
      ...
      <div class="span6">
        ...
        <div class="controls">
            <input name="loginURL" type="text" class="span12" value="#encodeForHTMLAttribute(rc.siteBean.getLoginURL(parseMuraTag=false))#" maxlength="255">
          </div>
      </div>
        <div class="span6">
        <label class="control-label">Custom Profile URL</label>
        <div class="controls">
            <input name="editProfileURL" type="text" class="span12" value="#encodeForHTMLAttribute(rc.siteBean.getEditProfileURL(parseMuraTag=false))#" maxlength="255">
          </div>
      </div>
        </div>
    ...
    <div id="tabDisplayregions" class="tab-pane fade">
        ...
        <div class="controls">
            <input name="columnNames" type="text" class="span6" value="#encodeForHTMLAttribute(rc.siteBean.getcolumnNames())#">
          </div>
      </div>
            ...
            <cfset attributesArray=extendSetBean.getAttributes() />
              ...
              <div class="control-group">
                  ...
                  <cfif len(attributeBean.getHint())>
                      <a rel="tooltip" href="##" title="#encodeForHTMLAttribute(attributeBean.gethint())#">#attributeBean.getLabel()# <i class="icon-question-sign"></i></a>
                      <cfelse>
#attributeBean.getLabel()#
    ...
    <div id="tabRazuna" class="tab-pane fade">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" class="span6" value="#encodeForHTMLAttribute(rc.razunaSettings.getHostName())#" id="razuna_hostname" name="hostname"> 
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" class="span6" value="#encodeForHTMLAttribute(rc.razunaSettings.getHostID())#" id="razuna_hostid" name="hostid"> 
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" class="span6" value="#encodeForHTMLAttribute(rc.razunaSettings.getDAMPath())#" id="razuna_dampath" name="damPath"> 
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" class="span6" value="#encodeForHTMLAttribute(rc.razunaSettings.getApiKey())#" id="razuna_api_key" name="apikey">
        </div>
      </div>
    </div>
 </div>
  ...
  <cfoutput query="rsPluginScripts" group="pluginID"> 
    <!---<cfset tabLabelList=tabLabelList & ",'#encodeForJavascript(rsPluginScripts.name)#'"/>--->
