...
<ul class="metadata">
<li><strong>Name:</strong> #tempEncodeForHTML(rc.pluginConfig.getName())#</li>
<li><strong>Category:</strong> #tempEncodeForHTML(rc.pluginConfig.getCategory())#</li>
<li><strong>Version:</strong> #tempEncodeForHTML(rc.pluginConfig.getVersion())#</li>
<li><strong>Provider:</strong> #tempEncodeForHTML(rc.pluginConfig.getProvider())#</li>
<li><strong>Provider URL:</strong> <a href="#rc.pluginConfig.getProviderURL()#" target="_blank">#tempEncodeForHTML(rc.pluginConfig.getProviderURL())#</a></li>
