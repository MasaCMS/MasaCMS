...
<cfif not len($.event('startDate'))>
	<cfset $.event('startDate', dateFormat(dateAdd("d", -14, now()), "mm/dd/yyyy"))>	
</cfif>
<cfif not len($.event('endDate'))>
	<cfset $.event('endDate', dateFormat(now(), "mm/dd/yyyy"))>	
</cfif>
					...
					<div class="commentform-actions">
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li><a><i class="icon-ok"></i> Approved</a></li>
