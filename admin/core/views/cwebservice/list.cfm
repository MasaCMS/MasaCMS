		  ...
		  <cfelse>
			...
			<tbody class="nest">
				...
				<tr>
					...
					<td>
						<cfif service.getGrantType() eq 'client_credentials'>OAuth2 (client_credentials)<cfelseif service.getGrantType() eq 'authorization_code'>OAuth2 (authorization_code)<cfelseif service.getGrantType() eq 'implicit'>OAuth2 (implicit)<cfelse>Basic</cfif>
					</td>
					<td>
