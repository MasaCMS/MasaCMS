...
<cfoutput query="rc.rslist" startrow="#rc.startrow#" maxrows="#rc.nextN.RecordsPerPage#">
	<tr>
		<td class="var-width"><a href="mailto:#encodeForHTML(rc.rslist.email)#">#encodeForHTML(rc.rslist.email)#</a></td>
		<td>#encodeForHTML(rc.rslist.fname)#&nbsp;#encodeForHTML(rc.rslist.lname)#</td>
		<td>#encodeForHTML(rc.rslist.company)#</td>
