...
<cfoutput query="rc.rslist">
	<tr>
		<td class="var-width"><a title="Edit" href="./?muraAction=cMailingList.edit&mlid=#rc.rslist.mlid#&siteid=#URLEncodedFormat(rc.siteid)#">#HTMLEditFormat(rc.rslist.name)# (#rc.rslist.members#)</a></td>
