...
<cfif rc.listBean.getispurge() neq 1>
	<cfif rc.mlid eq ''>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="Name" value="#encodeForHTMLAttribute(rc.listBean.getname())#" required="true" message="#application.rbFactory.getKeyValue(session.rb,'mailinglistmanager.namerequired')#" class="span12">
			</div>
		</div>
	<cfelse>
...
<cfelse>
	...
	<div class="controls">
		<textarea id="description" name="description" rows="6" class="span12">#encodeForHTML(rc.listBean.getdescription())#</textarea>
	...
	<div class="form-actions">			
		...
		<cfelse>
			<cfif not rc.listBean.getispurge()>
				<input type="button" class="btn" onclick="submitForm(document.forms.form1,'delete','#encodeForJavascript(application.rbFactory.getKeyValue(session.rb,'mailinglistmanager.deleteconfirm'))#');" value="#application.rbFactory.getKeyValue(session.rb,'mailinglistmanager.delete')#" />
			</cfif> 
