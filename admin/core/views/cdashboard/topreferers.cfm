...
<cfloop query="rslist">
<tr>
<td class="var-width"><cfif rslist.referer neq 'Unknown'><a href="#rsList.referer#" target="_blank">#tempEncodeForHTML(left(rslist.referer,120))#</a><cfelse>#tempEncodeForHTML(rslist.referer)#</cfif></td>
