...
<cf_dsp_categories_nest_search siteID="#attributes.siteID#" parentID="#rslist.categoryID#" categoryID="#attributes.categoryID#" nestLevel="#val(attributes.nestLevel +1)#" ></li>
</cfoutput>
</ul>
</cfif>
