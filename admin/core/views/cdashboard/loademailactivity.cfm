...
<tr>
<td class="title"><a href="./?muraAction=cEmail.edit&siteid=#tempEncodeForURL(rc.siteid)#&emailID=#rslist.emailID#">#rsList.subject#</td><td>#sent#</td><td>#opens#</td><td>#clicks#</td><td>#bounces#</td>
</tr>
</cfloop>
<cfelse>
