...
<td class="actions"><ul class="one"><li class="viewDetails"><a title="#application.rbFactory.getKeyValue(session.rb,"dashboard.session.view")#" href="./?muraAction=cDashboard.viewSession&urlToken=#tempEncodeForURL(rc.rslist.urlToken)#&siteid=#tempEncodeForURL(rc.siteid)#"><i class="icon-pencil"></i></a></li></ul></td>
</tr></cfloop>
<cfelse>
<tr>
...
#application.rbFactory.getKeyValue(session.rb,"dashboard.session.moreresults")#: <cfif rc.nextN.currentpagenumber gt 1> <a href="./?muraAction=cDashboard.listSessions&startrow=#rc.nextN.previous#&siteid=#tempEncodeForURL(rc.siteid)#&direction=#rc.direction#&orderBy=#rc.orderBy#&spanType=#rc.spanType#&span=#rc.span#">&laquo;&nbsp;#application.rbFactory.getKeyValue(session.rb,"dashboard.session.prev")#</a></cfif>
<cfloop from="#rc.nextN.firstPage#"  to="#rc.nextN.lastPage#" index="i">
	<cfif rc.nextN.currentpagenumber eq i> #i# <cfelse> <a href="./?muraAction=cDashBoard.listSessions&startrow=#evaluate('(#i#*#rc.nextN.recordsperpage#)-#rc.nextN.recordsperpage#+1')#&siteid=#tempEncodeForURL(rc.siteid)#&direction=#rc.direction#&orderBy=#rc.orderBy#&spanType=#rc.spanType#&span=#rc.span#">#i#</a> </cfif></cfloop>
	<cfif rc.nextN.currentpagenumber lt rc.nextN.NumberOfPages><a href="./?muraAction=cDashboard.listSessions&startrow=#rc.nextN.next#&siteid=#tempEncodeForURL(rc.siteid)#&direction=#rc.direction#&orderBy=#rc.orderBy#&spanType=#rc.spanType#&span=#rc.span#">#application.rbFactory.getKeyValue(session.rb,"dashboard.session.next")#&nbsp;&raquo;</a></cfif> 
