...
<td class="actions">
		...
		<li class="preview"><a title="#application.rbFactory.getKeyValue(session.rb,"dashboard.session.view")#" href="##" onclick="return preview('#application.settingsManager.getSite(rc.siteid).getWebPath()##$.getURLStem(rc.siteid,rsList.filename)#');"><i class="icon-globe"></i></a></li>
		</ul></td>
</tr>
</cfloop>
<cfelse>
