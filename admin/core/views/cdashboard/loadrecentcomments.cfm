...
<table class="mura-table-grid">
	...
	<cfloop condition="comments.hasNext()">
		...
		<tr>
			...
			<td class="actions">
			<ul>
				<li class="preview"><a title="#application.rbFactory.getKeyValue(session.rb,"dashboard.view")#" href="##" onclick="return preview('#encodeForJavascript(content.getURL(complete=1,queryString='##comment-#comment.getCommentID()#'))#','#encodeForJavascript(content.getTargetParams())#');"><i class="icon-globe"></i></a></li>
			</ul>
			</td>
		</tr>
		</cfloop>
