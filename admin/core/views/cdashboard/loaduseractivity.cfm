...
<div id="userActivity" class="separate">
	<table class="table table-striped table-condensed mura-table-grid" id="recentActivity">
	<thead>
	<tr>
	...
	<table class="table table-striped table-condensed mura-table-grid" id="memberActivity">
	<thead>
	<tr>
