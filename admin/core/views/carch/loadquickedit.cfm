		...
		<cfif rc.$.globalConfig().getValue(property='advancedScheduling',defaultValue=false)>
			<div class="control-group">
				...
				<div id="editDates" <cfif content.getdisplay() NEQ 2>style="display: none;"</cfif>>
					...
					<div class="controls">
						<cf_datetimeselector name="displayStart" datetime="#content.getDisplayStart()#"> <span id="displayIntervalToLabel">#application.rbFactory.getKeyValue(session.rb,'sitemanager.content.fields.displayinterval.to')#</span>
						<cf_datetimeselector name="displayStop" datetime="#content.getDisplayStop()#" defaulthour="23" defaultminute="59"></span>
					</div>		
					...
					<div class="controls">
						...
						<cfif content.getParent().getType() eq 'Calendar'>
