		...
		<div id="editDates" <cfif request.quickeditscheduler or content.getdisplay() NEQ 2>style="display: none;"</cfif>>
			...
			<div class="mura-repeat-options mura-control-group" style="display:none">
				<div class="mura-control-inline">
					...
					<input type="text" id="displayIntervalEvery" name="displayIntervalEvery" value="#esapiEncode('html_attr',displayInterval.every)#" class="mura-repeat-option" maxlength="4">
