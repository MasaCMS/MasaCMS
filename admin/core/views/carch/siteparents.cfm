 ...
 <table class="mura-table-grid stripe">
	...
	<cfif rc.rslist.recordcount>
    	...
    	<cfoutput query="rc.rslist" startrow="1" maxrows="100">
			...
			<cfif verdict neq 'none' and structKeyExists(crumbdata[1],"parentArray") and not listFind(arraytolist(crumbdata[1].parentArray),rc.contentid) and rc.rslist.type neq 'Link' and rc.rslist.type neq 'File'>
