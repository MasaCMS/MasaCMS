...
<li>
<cfif rslist.isOpen eq 1><input type="checkbox" name="#attributes.elementName#" class="checkbox" <cfif listfind(attributes.categoryID,rslist.CategoryID)>checked</cfif> value="#rslist.categoryID#"/> </cfif>#HTMLEditFormat(rslist.name)#
<cfif rslist.hasKids>
