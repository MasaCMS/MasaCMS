			...
			<div class="pagination">
			 <ul>
			  <cfif nextN.currentpagenumber gt 1>
			  	<li>
			  	<a href="" onclick="return siteManager.loadSiteManager('#tempEncodeForJavascript(rc.siteid)#','#tempEncodeForJavascript(rc.topid)#','00000000000000000000000000000000000','','','#tempEncodeForJavascript(rc.ptype)#',#nextN.previous#);">&laquo;&nbsp;#application.rbFactory.getKeyValue(session.rb,'sitemanager.prev')#</a> 
			  	</li>
			  </cfif>
			  ...
			  <cfelse>  
			  		<li>
			  			<a href="" onclick="return siteManager.loadSiteManager('#tempEncodeForJavascript(rc.siteid)#','#tempEncodeForJavascript(rc.topid)#','00000000000000000000000000000000000','','','#tempEncodeForJavascript(rc.ptype)#',#evaluate('(#i#*#nextN.recordsperpage#)-#nextN.recordsperpage#+1')#);">#i#</a>
			  		</li>
			  	</cfif>
		     </cfloop>
			 <cfif nextN.currentpagenumber lt nextN.NumberOfPages>
			 	<li>
			 		<a href="" onclick="return siteManager.loadSiteManager('#tempEncodeForJavascript(rc.siteid)#','#tempEncodeForJavascript(rc.topid)#','00000000000000000000000000000000000','','','#tempEncodeForJavascript(rc.ptype)#',#nextN.next#);">#application.rbFactory.getKeyValue(session.rb,'sitemanager.next')#&nbsp;&raquo;</a> 
			 	</li>
			 </cfif>
			</ul>
			</div>
