...
<td class="var-width">#tempEncodeForHTML(changeset.getName())#</td>
</tr>
</cfloop>
<tr>
...
<td class="var-width">#tempEncodeForHTML(application.rbFactory.getKeyValue(session.rb,"sitemanager.content.none"))#</td>
</tr>
<cfelse>
<tr>
...
<input type="checkbox" id="_removePreviousChangeset" value="true"/>&nbsp;#application.rbFactory.getResourceBundle(session.rb).messageFormat(application.rbFactory.getKeyValue(session.rb,"sitemanager.content.removechangeset"),'<em>"#tempEncodeForHTMLAttribute(currentChangeset.getName())#"</em>')#
</div>
</cfoutput>