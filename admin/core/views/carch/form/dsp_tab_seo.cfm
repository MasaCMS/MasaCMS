  ...
  <div id="tabSEO" class="tab-pane fade">
	  ...
	  <div class="fieldset">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="menuTitle" name="menuTitle" value="#tempEncodeForHTMLAttribute(rc.contentBean.getmenuTitle())#"  maxlength="255" class="span12">
						</div>
					</div>
							
					<div class="control-group">
			      		<label class="control-label">
			      			<a href="##" rel="tooltip" title="#tempEncodeForHTMLAttribute(application.rbFactory.getKeyValue(session.rb,"tooltip.urlTitle"))#">
			      				#application.rbFactory.getKeyValue(session.rb,"sitemanager.content.fields.urltitle")#
			      			 <i class="icon-question-sign"></i></a>
			      		</label>
						<div class="controls">
								<input type="text" id="urlTitle" name="urlTitle" value="#tempEncodeForHTMLAttribute(rc.contentBean.getURLTitle())#"  maxlength="255" class="span12">
						</div>
					</div>
						
					<div class="control-group">
			      		<label class="control-label">
			      			<a href="##" rel="tooltip" title="#tempEncodeForHTMLAttribute(application.rbFactory.getKeyValue(session.rb,"tooltip.htmlTitle"))#">
			      				#application.rbFactory.getKeyValue(session.rb,"sitemanager.content.fields.htmltitle")#
			      			 <i class="icon-question-sign"></i></a>
			      		</label>
						<div class="controls">
							<input type="text" id="htmlTitle" name="htmlTitle" value="#tempEncodeForHTMLAttribute(rc.contentBean.getHTMLTitle())#"  maxlength="255" class="span12">
						</div>
					</div>

					 <div class="control-group">
					  <label class="control-label">#application.rbFactory.getKeyValue(session.rb,'sitemanager.content.fields.description')#</label>
					      <div class="controls"><textarea name="metadesc" rows="8" id="metadesc" class="span12">#tempEncodeForHTML(rc.contentBean.getMETADesc())#</textarea></div>
					    </div>

					  <div class="control-group">
					  <label class="control-label">#application.rbFactory.getKeyValue(session.rb,'sitemanager.content.fields.keywords')#</label>
					      <div class="controls"><textarea name="metakeywords" rows="8" id="metakeywords" class="span12">#tempEncodeForHTML(rc.contentBean.getMETAKEYWORDS())#</textarea></div>
					    </div>
