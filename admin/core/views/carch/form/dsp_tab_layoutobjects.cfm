...
<cfoutput>
  ...
  <div class="fieldset">
      ...
      <div class="control-group">
        ...
        <div class="span6">
              <label class="control-label">
                <cfoutput><a href="##" rel="tooltip" title="#tempEncodeForHTMLAttribute(application.rbFactory.getKeyValue(session.rb,"tooltip.layoutTemplate"))#">#application.rbFactory.getKeyValue(session.rb,'sitemanager.content.fields.layouttemplate')# <i class="icon-question-sign"></i></a></cfoutput>
            </label>
            <div class="controls">
        ...
        <div class="span6">
        <label class="control-label">
                <cfoutput><a href="##" rel="tooltip" title="#tempEncodeForHTMLAttribute(application.rbFactory.getKeyValue(session.rb,"tooltip.childTemplate"))#">#application.rbFactory.getKeyValue(session.rb,'sitemanager.content.fields.childtemplate')# <i class="icon-question-sign"></i></a></cfoutput>
              </label>
              <div class="controls">
    ...
    <div class="control-group">
      <label class="control-label"> <a href="##" rel="tooltip" title="#tempEncodeForHTMLAttribute(application.rbFactory.getKeyValue(session.rb,"tooltip.inheritanceRules"))#"> #application.rbFactory.getKeyValue(session.rb,'sitemanager.content.fields.inheritancerules')# <i class="icon-question-sign"></i> </a> </label>
       <cfif structKeyExists(request, "inheritedObjects") and len(request.inheritedObjects)>
          ...
          <cfif listFindNoCase("author,editor",application.permUtility.getnodePerm(inheritBean.getCrumbArray()))>
             <strong><a href='#inheritBean.getEditURL(compactDisplay=yesNoFormat(rc.compactdisplay),tab='tabLayoutObjects')#'>#tempEncodeForHTML(inheritBean.getMenuTitle())#</a></strong>
          <cfelse>
             <strong>#tempEncodeForHTML(inheritBean.getMenuTitle())#</strong>
          </cfif>
              ...
              <dd>
                <select name="selectedObjects#r#" id="selectedObjects#r#" class="multiSelect displayRegions" multiple="multiple" size="4" data-regionid="#r#">
                  <cfloop query="request.rsContentObjects#r#">
                    <option  value="#request["rsContentObjects#r#"].object#~#tempEncodeForHTML(request["rsContentObjects#r#"].name)#~#request["rsContentObjects#r#"].objectid#~#tempEncodeForHTML(request["rsContentObjects#r#"].params)#">
                    #request["rsContentObjects#r#"].name#
						      
                    </option>
                    <cfset variables["objectlist#r#"]=listappend(variables["objectlist#r#"],"#request["rsContentObjects#r#"].object#~#tempEncodeForHTML(request["rsContentObjects#r#"].name)#~#request["rsContentObjects#r#"].objectid#~#tempEncodeForHTML(request["rsContentObjects#r#"].params)#","^")>
                  </cfloop>
                </select>
