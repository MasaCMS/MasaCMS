			...
			<div class="help-block" id="mura-content-metadata">
				<cfif not rc.contentBean.getIsNew()>
					...
					<span class="meta-label meta-label-wide">
				      ...
				      <span><cfif len(rc.contentID) and len(rc.contentBean.getcontentID())>#rc.contentBean.getcontentID()#<cfelse>#application.rbFactory.getKeyValue(session.rb,'sitemanager.content.fields.notavailable')#</cfif></span>
				    </span>
