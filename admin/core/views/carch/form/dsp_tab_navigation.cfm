...
--->
<cfset tabLabelList=listAppend(tabLabelList,application.rbFactory.getKeyValue(session.rb,"sitemanager.content.tabs.navigation"))/>
<cfset tabList=listAppend(tabList,"tabNavigation")>
<cfoutput>
  <div id="tabNavigation" class="tab-pane fade">
    ...
    <span id="extendset-container-navigation" class="extendset-container"></span>
