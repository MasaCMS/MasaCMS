		...
		<div class="control-group">
			...
			<select id="availableObjectSelector">
				...
				<cfloop query="rc.rsmailinglists">
					<option <cfif rc.object eq 'mailing_list' and rc.objectid eq rc.rsmailinglists.mlid>selected </cfif>value="{'object':'mailing_list','name':'#esapiEncode('html_attr','Mailing List - #rc.rsmailinglists.name#')#','objectid':'#rc.rsmailinglists.mlid#'}">
