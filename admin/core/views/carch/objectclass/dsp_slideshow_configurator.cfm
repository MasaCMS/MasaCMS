...
<cfelse>
	...
	data-name="#tempEncodeForHTMLAttribute('#feed.getName()# - #application.rbFactory.getKeyValue(session.rb,'sitemanager.content.fields.localindexslideshow')#')#" 
...
<div class="control-group">
	...
	<div id="altNameContainer" class="span6"<cfif NOT feed.getDisplayName()> style="display:none;"</cfif>>
			...
			<div class="controls"><input class="objectParam span12" name="altName" data-displayobjectparam="altName" type="text" value="#tempEncodeForHTMLAttribute(feed.getAltName())#" maxlength="50">
			  </div>
	</div>
