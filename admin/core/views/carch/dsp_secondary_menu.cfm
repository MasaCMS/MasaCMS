		...
		<cfcase value="00000000000000000000000000000000003">
			<cfif rc.originalcircuit eq 'cPerm' or rc.perm neq 'none'>
				<cfif listFind(session.mura.memberships,'Admin;#application.settingsManager.getSite(rc.siteid).getPrivateUserPoolID()#;0') or listFind(session.mura.memberships,'S2')>
					<a class="btn <cfif rc.originalfuseaction eq "main"> active</cfif>" href="index.cfm?muraAction=cPerm.main&contentid=00000000000000000000000000000000003&topid=#URLEncodedFormat(rc.topid)#&siteid=#URLEncodedFormat(rc.siteid)#&moduleid=#rc.moduleid#&startrow=#rc.startrow#">Permissions</a>
				</cfif>
			</cfif>
		</cfcase>
		<cfcase value="00000000000000000000000000000000004">
			<cfif rc.originalcircuit eq 'cPerm' or rc.perm neq 'none'>
				<cfif listFind(session.mura.memberships,'Admin;#application.settingsManager.getSite(rc.siteid).getPrivateUserPoolID()#;0') or listFind(session.mura.memberships,'S2')><a class="btn<cfif rc.originalfuseaction eq 'main'> active</cfif>" href="index.cfm?muraAction=cPerm.main&contentid=00000000000000000000000000000000004&topid=#URLEncodedFormat(rc.topid)#&siteid=#URLEncodedFormat(rc.siteid)#&moduleid=#rc.moduleid#&startrow=#rc.startrow#">Permissions</a></cfif>
			</cfif>
		</cfcase>
	</cfswitch>
