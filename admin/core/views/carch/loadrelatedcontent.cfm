...
<cfoutput>
	<script>
		...
		function createExternalLink(){
			...
			if($('##mura-related-title').val()=='' || $('##mura-related-url').val()==''){
				...
				alertDialog("#tempEncodeForJavascript(application.rbFactory.getKeyValue(session.rb,'sitemanager.content.relatedcontent.newcontentvalidation'))#");
	...
	<div class="control-group">
		<label class="control-label"><a href="##" rel="tooltip" title="#tempEncodeForHTMLAttribute(application.rbFactory.getKeyValue(session.rb,'tooltip.addrelatedcontent'))#">#application.rbFactory.getKeyValue(session.rb,'sitemanager.content.relatedcontent.whereistherelatedcontent')# <i class="icon-question-sign"></i></a></label>
		<div class="controls">
