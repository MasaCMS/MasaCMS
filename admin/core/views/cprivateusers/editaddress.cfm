...
<cfoutput>
<form novalidate="novalidate" action="./?muraAction=cPrivateUsers.updateAddress&userid=#encodeForURL(rc.userid)#&routeid=#rc.routeid#&siteid=#encodeForURL(rc.siteid)#" method="post" enctype="multipart/form-data" name="form1" onsubmit="return validate(this);"  autocomplete="off">
...
<div class="fieldset-wrap">
	<div class="fieldset">
      ...
      <div class="controls"><textarea rows="6" class="span6" id="hours" name="hours" >#encodeForHTML(rsAddress.hours)#</textarea>
      </div>
    </div>
