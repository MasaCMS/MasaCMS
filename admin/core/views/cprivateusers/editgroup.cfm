  ...
  <div class="control-group">
   <label class="control-label">#application.rbFactory.getKeyValue(session.rb,'user.tablist')#</label>
    <div class="controls">
      ...
      <cfloop list="Basic,SEO,Meta Data,Template Assignments,Content Objects,Categorization,Related Content,Extended Attributes,Advanced,Usage Report,Publishing" index="t">
