        ...
        <cfif rc.rsgrouplist.recordcount>
          <cfoutput query="rc.rsgrouplist" maxrows="#rc.nextN.recordsperPage#" startrow="#rc.startrow#"> 
             <tr> 
                  ...
                  <td><cfif rc.rsgrouplist.email gt ""><a href="mailto:#rc.rsgrouplist.email#">#encodeForHTML(rc.rsgrouplist.email)#</a><cfelse>&nbsp;</cfif></td>
                ...
                <td>#rc.rsgrouplist.LastUpdateBy#</td>
                  <td class="actions"><ul class="group"><li class="edit"><a href="./?muraAction=#iif(rc.rsgrouplist.isPublic,de('cPublicUsers'),de('cPrivateUsers'))#.edituser&userid=#rc.rsgrouplist.UserID#&routeid=#encodeForURL(rc.userid)#&siteid=#encodeForURL(rc.siteid)#"><i class="icon-pencil"></i></a></li><li class="delete"><a href="./?muraAction=cPrivateUsers.removefromgroup&userid=#rc.rsgrouplist.UserID#&routeid=#encodeForURL(rc.userid)#&groupid=#encodeForURL(rc.userid)#&siteid=#encodeForURL(rc.siteid)#" onclick="return confirmDialog('#encodeForJavascript(application.rbFactory.getKeyValue(session.rb,'user.removeconfirm'))#',this.href)"><i class="icon-remove-sign"></i></a></li></ul></td>
              </tr>
          </cfoutput> 
      <cfelse>
              <tr> 
