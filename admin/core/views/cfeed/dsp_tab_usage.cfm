 ...
 <table id="metadata" class="mura-table-grid stripe">
    ...
    <cfif rsUsage.recordcount>
     <cfoutput query="rsUsage">
      ...
      <cfelse>
      <tr> 
        <td colspan="7" class="noResults"><cfoutput><cfif rc.feedBean.getType() eq 'Local'>#application.rbFactory.getKeyValue(session.rb,'collections.noindexusage')#<cfelse>#application.rbFactory.getKeyValue(session.rb,'collections.nofeedusage')#</cfif></cfoutput></td>
      </tr>
    </cfif>
	  </table>
</td></tr></table>
