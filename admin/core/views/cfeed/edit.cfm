...
<div class="fieldset">
	<cfif rc.feedID neq ''>
		...
		<div class="controls">
	     <a title="#application.rbFactory.getKeyValue(session.rb,'collections.view')#" href="http://#application.settingsManager.getSite(rc.siteid).getDomain()##application.configBean.getServerPort()##application.configBean.getContext()#/index.cfm/_feed/#rc.feedBean.getSiteID()#/?feedID=#rc.feedBean.getFeedID()#" target="_blank">http://#application.settingsManager.getSite(rc.siteid).getDomain()##application.configBean.getServerPort()##application.configBean.getContext()#/index.cfm/_feed/#rc.feedBean.getSiteID()#/?feedID=#rc.feedBean.getFeedID()#</a>
	     </div>
		</div>
	</cfif>
