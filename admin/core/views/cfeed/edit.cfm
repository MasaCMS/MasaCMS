...
<form novalidate="novalidate" action="./?muraAction=cFeed.update&siteid=#encodeForURL(rc.siteid)#" method="post" name="form1" id="feedFrm" onsubmit="return validate(this);"<cfif len(rc.assignmentID)> style="width: 412px"</cfif>>
...
<cfelse>
	<!---<h2>#encodeForHTML(rc.feedBean.getName())#</h2>--->
	<cfsilent>
	...
	<!--- Basic Tab --->
		...
		<div class="fieldset">
			...
			<div class="control-group">
			  ...
			  <label class="control-label"><input type="text" name="name" class="span12" required="true" message="#application.rbFactory.getKeyValue(session.rb,'collections.namerequired')#" value="#encodeForHTMLAttribute(rc.feedBean.getName())#" maxlength="250"<cfif rc.feedBean.getIsLocked()> disabled="disabled"</cfif>></label>
			</div>
				...
				<div class="span6">
					...
					<div class="controls">
						<select name="sortBy">
							...
							<cfloop query="rsExtend">
								<option value="#encodeForHTMLAttribute(rsExtend.attribute)#" <cfif rc.feedBean.getsortBy() eq rsExtend.attribute>selected</cfif>>#rsExtend.Type#/#rsExtend.subType# - #rsExtend.attribute#</option>
							</cfloop>
						</select>
					</div>
				</div>
...
<div id="tabAdvancedfilters" class="tab-pane fade">
	...
	<div class="control-group" id="searchParams">
		...
		<input type="text" name="paramCriteria#rsParams.currentRow#" value="#encodeForHTMLAttribute(rsParams.criteria)#" class="span4" >
...
<div class="fieldset">
<cfif isObjectInstance><h2>#encodeForHTML(rc.feedBean.getName())#</h2></cfif>
			...
			<div class="controls">
				<select name="#displaNamePrefix#imageSize" data-displayobjectparam="imageSize" class="span12" onchange="if(this.value=='custom'){jQuery('##feedCustomImageOptions').fadeIn('fast')}else{jQuery('##feedCustomImageOptions').hide();jQuery('##feedCustomImageOptions').find(':input').val('AUTO');}">
					...
					<cfloop condition="imageSizes.hasNext()">
						...
						<option value="#lcase(image.getName())#"<cfif image.getName() eq rc.feedBean.getImageSize()> selected</cfif>>#encodeForHTML(image.getName())#</option>
					</cfloop>
...
<span id="altNameContainer" class="span6"<cfif NOT rc.feedBean.getDisplayName()> style="display:none;"</cfif>>
	<div>
		...
		<div class="controls"><input class="span12" name="#displaNamePrefix#altName" data-displayobjectparam="altName" type="text" value="#encodeForHTMLAttribute(rc.feedBean.getAltName())#" maxlength="250">
		  </div>
	</div>
</span>
...
<div class="control-group">
		...
		<div class="controls">
			<input name="cssclass" class="span12"  data-displayobjectparam="cssclass" type="text" value="#encodeForHTMLAttribute(rc.feedBean.getCssclass())#" maxlength="255">
		</div>
...
<div class="control-group">
	<div class="span6">
		...
		<div class="controls">
			<input name="viewalllink" class="span12" data-displayobjectparam="viewallink" type="text" value="#encodeForHTMLAttribute(rc.feedBean.getViewAllLink())#" maxlength="255">
		</div>
	</div>
	...
	<div class="span6">
		...
		<div class="controls">
			<input name="viewalllabel" class="span12" data-displayobjectparam="viewalllabel" type="text" value="#encodeForHTMLAttribute(rc.feedBean.getViewAllLabel())#" maxlength="100">
		</div>
	</div>
</div>
...
<div class="fieldset">
	...
	<div class="controls"><textarea rows="6" class="span12" name="description">#encodeForHTMLAttribute(rc.feedBean.getDescription())#</textarea>
	  </div>
	</div> 
	...
	<div class="control-group">
		...
		<div class="controls">
			<input name="lang" type="text" value="#encodeForHTMLAttribute(rc.feedBean.getlang())#" maxlength="50">
		</div>
	</div>
</div>
...
<cfelse>
	<cfif rc.compactDisplay neq "true">
		<input type="button" class="btn" onclick="submitForm(document.forms.form1,'delete','#encodeForJavascript(application.rbFactory.getKeyValue(session.rb,'collections.deletelocalconfirm'))#');" value="#application.rbFactory.getKeyValue(session.rb,'collections.delete')#" /> 
	</cfif>
	<cfif isObjectInstance>
...
<input type="hidden" name="assignmentID" value="#encodeForHTMLAttribute(rc.assignmentID)#" />
<input type="hidden" name="orderno" value="#encodeForHTMLAttribute(rc.orderno)#" />
<input type="hidden" name="regionid" value="#encodeForHTMLAttribute(rc.regionID)#" />
...
<form novalidate="novalidate" action="./?muraAction=cFeed.update&siteid=#encodeForURL(rc.siteid)#" method="post" name="form1" onsubmit="return validate(this);">
</cfoutput>
<cfsavecontent variable='tabContent'>
<cfoutput>
<div id="tabBasic" class="tab-pane fade">
...
<div class="fieldset">	
	...
	<div class="span6">
      <label class="control-label">#application.rbFactory.getKeyValue(session.rb,'collections.name')#</label>
      <div class="controls"><input name="name" type="text" class="span12" required="true" message="#application.rbFactory.getKeyValue(session.rb,'collections.namerequired')#" value="#encodeForHTMLAttribute(rc.feedBean.getName())#" maxlength="50">  </div>
    </div>
	<div class="span6">
	      <label class="control-label">#application.rbFactory.getKeyValue(session.rb,'collections.url')#</label>
	      <div class="controls">
	      	<input name="channelLink" class="span12" type="text" required="true" message="#application.rbFactory.getKeyValue(session.rb,'collections.urlrequired')#" value="#encodeForHTMLAttribute(rc.feedBean.getChannelLink())#" maxlength="250">
	      </div>
	</div>
</div>
...
<div class="control-group">
    <div class="span6">
		...
		<div class="controls">
			<input name="viewalllink" class="span12" type="text" value="#encodeForHTMLAttribute(rc.feedBean.getViewAllLink())#" maxlength="255">
		</div>
	</div>
	...
	<div class="span6">
		...
		<div class="controls">
			<input name="viewalllabel" class="span12" type="text" value="#encodeForHTMLAttribute(rc.feedBean.getViewAllLabel())#" maxlength="100">
		</div>
	</div>
</div>
...
<div class="tabbable tabs-left mura-ui">
	...
	<div class="form-actions">
		...
		<cfelse>
			<cfif rc.compactDisplay neq "true">
				<input type="button" class="btn" onclick="submitForm(document.forms.form1,'delete','#encodeForJavascript(application.rbFactory.getKeyValue(session.rb,'collections.deleteremoteconfirm'))#');" value="#application.rbFactory.getKeyValue(session.rb,'collections.delete')#" /> 
			</cfif>
			<input type="button" class="btn" onclick="submitForm(document.forms.form1,'update');" value="#application.rbFactory.getKeyValue(session.rb,'collections.update')#" />
			<cfif rc.compactDisplay eq "true">
				<input type="hidden" name="closeCompactDisplay" value="true" />
