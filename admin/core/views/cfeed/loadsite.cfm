 ...
 <table class="table table-striped table-condensed table-bordered mura-table-grid">
    ...
    <tbody>
     <cfoutput query="rc.rslist" startrow="1" maxrows="100">	
		...
		<td class="actions"><ul><li class="add"><a title="#application.rbFactory.getKeyValue(session.rb,'collections.add')#" href="javascript:;" onClick="feedManager.addContentFilter('#rc.rslist.contentid#','#JSStringFormat(application.rbFactory.getKeyValue(session.rb,'sitemanager.content.type.#rc.rslist.type#'))#','#JSStringFormat(application.contentRenderer.dspZoomText(crumbdata,"&raquo;"))#'); return false;"><i class="icon-plus-sign"></i></a></li></ul>
		  </td>
		</tr>
	 	</cfif>
       </cfoutput>
