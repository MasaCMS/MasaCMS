		...
		<cfdefaultcase>
			...
			<cfif isDefined('rc.feedBean') and not rc.feedBean.getIsNew()>
				<cfif rc.feedBean.getType() eq 'Local'>
					<a class="btn" title="#application.rbFactory.getKeyValue(session.rb,'collections.view')#" href="#endpoint#/?feedID=#rc.feedBean.getfeedID()#" target="_blank"><i class="icon-rss"></i> #application.rbFactory.getKeyValue(session.rb,'collections.viewfeed')#</a>
				<cfelse>
