...
<div class="control-group">
  ...
  <div class="controls">
  <input name="name" type="text" class="span12" required="true" message="#application.rbFactory.getKeyValue(session.rb,'approvalchains.namerequired')#" value="#tempEncodeForHTMLAttribute(chain.getName())#" maxlength="50">
   </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
  <textarea name="description" class="span12" rows="6">#tempEncodeForHTML(chain.getDescription())#</textarea>
  </div>
</div>
    ...
    <ul id="groupAvailableListSort" class="groupDisplayListSortOptions">
      ...
      <cfloop condition="it.hasNext()">
        ...
        <li class="ui-state-default">
          #tempEncodeForHTML(item.getGroupName())#
    ...
    <ol id="groupAssignmentListSort" class="groupDisplayListSortOptions">  
      ...
      <cfloop condition="it.hasNext()">
        ...
        <li class="ui-state-highlight">
          #tempEncodeForHTML(item.getGroup().getGroupName())#
...
<div class="form-actions">
  ...
  <cfelse>
    <input type="button" class="btn" value="#application.rbFactory.getKeyValue(session.rb,'approvalchains.delete')#" onclick="confirmDialog('#tempEncodeForJavascript(application.rbFactory.getKeyValue(session.rb,'approvalchains.deleteconfirm'))#','./?muraAction=cchain.delete&chainID=#chain.getchainID()#&siteid=#tempEncodeForURL(chain.getSiteID())#')" /> 
