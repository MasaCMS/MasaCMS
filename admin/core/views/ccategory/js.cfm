...
<div id="newContentMenu" onMouseOut="categoryManager.hideMenu('newContentMenu');" class="addNew hide">
  <ul>
    <li id="newPage"><a href="" id="newCategoryLink" onMouseOver="categoryManager.keepMenu('newContentMenu');"><i class="mi-plus"></i> <cfoutput>#application.rbFactory.getKeyValue(session.rb,'categorymanager.addsubcategory')#</cfoutput></a></li>
 </ul>
</div>
</cfoutput>
</cfsavecontent>
