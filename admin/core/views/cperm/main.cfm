...
<cfif rc.moduleid eq '00000000000000000000000000000000000'>#application.contentRenderer.dspZoom(crumbdata=rc.crumbdata,fileExt=rc.rsContent.fileEXT,class="navZoom alt")#</cfif>
