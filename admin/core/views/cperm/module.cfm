...
<section>
  <form novalidate="novalidate"  method="post" name="form1" action="./?muraAction=cPerm.updatemodule&contentid=#encodeForURL(rc.contentid)#">
 ...
 <table class="mura-table-grid">
	...
	<cfif rc.rslist.recordcount>
        <cfloop query="rc.rslist"> 
            <tr> 
              	<td><input type="checkbox" name="groupid" value="#rc.rslist.userid#"<cfif application.permUtility.getGroupPermVerdict(rc.contentid,rc.rslist.userid,'module',rc.siteid)>checked</cfif>></td>
	      		<td class="var-width" nowrap>#encodeForHTML(rc.rslist.GroupName)#</td>
			</tr>
		 </cfloop>
	<cfelse>
		 <tr> 
