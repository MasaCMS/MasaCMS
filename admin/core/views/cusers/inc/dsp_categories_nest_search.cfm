		...
		<cfoutput query="rslist">
			<li>
				<cfif rslist.isOpen eq 1>
					<input type="checkbox" name="categoryID" class="checkbox" <cfif listfind(session.paramCategories,rslist.CategoryID)>checked</cfif> value="#rslist.categoryID#"> 
				</cfif>

				#rslist.name#

				<cfif rslist.hasKids>
					<cf_dsp_categories_nest_search 
