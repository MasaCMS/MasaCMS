...
<li><a href="./?muraAction=cUsers.search&amp;siteid=#URLEncodedFormat(rc.siteid)#">#rc.$.rbKey("user.basicsearch")#</a></li>
</ul>
	...
	<div class="control-group" id="searchParams">
	      ...
	      <div class="controls">
			<cfif rc.newSearch or (session.paramCircuit neq 'cUsers' or not session.paramCount)>
				...
				<a class="criteria remove" href="javascript:;" onclick="searchParams.removeSeachParam(this.parentNode);searchParams.setSearchButtons();return false;" style="display:none;" title="#rc.$.rbKey("params.removecriteria")#"><i class="icon-remove-sign"></i></a>
				<a class="criteria add" href="javascript:;" onclick="searchParams.addSearchParam();searchParams.setSearchButtons();return false;" title="#rc.$.rbKey("params.addcriteria")#"><i class="icon-plus-sign"></i></a>
				
			<cfelse>
				<cfloop from="1" to="#session.paramCount#" index="p">
				<select name="paramRelationship#p#" class="span2">
					<option value="and" <cfif session.paramArray[p].relationship eq "and">selected</cfif> >#rc.$.rbKey("params.and")#</option>
					<option value="or" <cfif session.paramArray[p].relationship eq "or">selected</cfif> >#rc.$.rbKey("params.or")#</option>
				</select>
				...
				<a class="removeCriteria" href="javascript:;" onclick="searchParams.removeSeachParam(this.parentNode);searchParams.setSearchButtons();return false;"><span>#rc.$.rbKey("params.removecriteria")#</span></a>
				<a class="addCriteria" href="javascript:;" onclick="searchParams.addSearchParam();searchParams.setSearchButtons();return false;" ><span>#rc.$.rbKey("params.addcriteria")#</span></a>
				</cfloop>
			</cfif>
			</div>
	</div>
...
<input type="hidden" name="muraAction" value="cUsers.advancedSearch" /><input type="hidden" name="siteid" value="#HTMLEditFormat(rc.siteid)#"/>
<button type="button" class="btn" onclick="document.forms.form2.muraAction.value='cUsers.advancedSearch';submitForm(document.forms.form2);"><i class="icon-search"></i> #rc.$.rbKey("user.search")#</button>
<button type="button" class="btn" onclick="document.forms.form2.muraAction.value='cUsers.advancedSearchToCSV';submitForm(document.forms.form2);"><i class="icon-download"></i> #rc.$.rbKey("user.download")#</button>
</div>
</form>
</cfoutput>
        ...
        <table class="mura-table-grid">
          ...
          <cfif rc.rsList.recordcount>
            <cfoutput query="rc.rsList" maxrows="#rc.nextN.recordsperPage#" startrow="#rc.startrow#"> 
              <tr> 
                <td class="var-width"><a title="Edit" href="./?muraAction=cUsers.edituser&amp;userid=#rc.rsList.UserID#&amp;type=2&amp;siteid=#URLEncodedFormat(rc.siteid)#&amp;returnURL=#URLEncodedFormat(rc.currentURL)#">#HTMLEditFormat(lname)#, #HTMLEditFormat(fname)# <cfif company neq ''> (#HTMLEditFormat(company)#)</cfif></a></td>
			  ...
			  <td>#HTMLEditFormat(rc.rsList.LastUpdateBy)#</td>
                <td class="actions"><ul><li class="edit"><a title="#rc.$.rbKey('user.edit')#" href="./?muraAction=cUsers.edituser&amp;userid=#rc.rsList.UserID#&amp;type=2&amp;siteid=#URLEncodedFormat(rc.siteid)#&amp;returnURL=#URLEncodedFormat(rc.currentURL)#"><i class="icon-pencil"></i></a></li></ul></td>
              </tr>
            </cfoutput>
			
            <cfelse>
            <tr> 
              <td colspan="6" class="noResults"><cfoutput>#rc.$.rbKey('user.nosearchresults')#</cfoutput></td>
            </tr>
          </cfif>   
        </table>
...
<cfoutput>
		...
		<cfif rc.nextN.currentpagenumber gt 1>
			<li>
				<a href="./?muraAction=cUsers.advancedSearch&amp;startrow=#rc.nextN.previous#&amp;siteid=#URLEncodedFormat(rc.siteid)#">&laquo;&nbsp;#rc.$.rbKey('user.prev')#</a></li>
			</cfif>
			...
			<cfelse> 
				<li>
					<a href="./?muraAction=cUsers.advancedSearch&amp;startrow=#evaluate('(#i#*#rc.nextN.recordsperpage#)-#rc.nextN.recordsperpage#+1')#&amp;siteid=#URLEncodedFormat(rc.siteid)#">#i#</a> 
				</li>
			</cfif>
			</cfloop>
			<cfif rc.nextN.currentpagenumber lt rc.nextN.NumberOfPages>
				<li><a href="./?muraAction=cUsers.advancedSearch&amp;startrow=#rc.nextN.next#&amp;siteid=#URLEncodedFormat(rc.siteid)#">#rc.$.rbKey('user.next')#&nbsp;&raquo;</a></li>
			</cfif> 
			</ul>
		</div>
		</div>
