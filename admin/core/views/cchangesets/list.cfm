	...
	<tr>
		...
		<td class="actions">
			<ul>
				...
				<cfelse>
					<li class="preview"><a title="#application.rbFactory.getKeyValue(session.rb,'changesets.preview')#" href="##" onclick="return preview('#application.settingsManager.getSite(rc.siteid).getWebPath()##$.getURLStem(rc.siteid,"")#?changesetID=#esapiEncode('javascript',rc.changeset.getChangeSetID())#','');"><i class="icon-globe"></i></a></li>
				</cfif>
