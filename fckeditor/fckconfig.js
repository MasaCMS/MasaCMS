...
FCKConfig.SkinPath = FCKConfig.BasePath + 'skins/mura/' ;
...
FCKConfig.ToolbarSets["Default"] = [
	...
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Link','Unlink','Anchor'],
	['Image','Flash','flvPlayer','googlemaps','-','Table','Rule','SpecialChar'],
	['Selectlink','SelectComponent','Templates','-','Style','FontFormat','-','FitWindow','ShowBlocks','-','About']	
] ;
...
FCKConfig.ToolbarSets["Basic"] = [
	['Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','FitWindow','ShowBlocks','-','About']
] ;
...
FCKConfig.ImageUploadAllowedExtensions	= ".(jpg|gif|jpeg|png|bmp|flv|swf)$" ;		// empty for all
...
FCKConfig.GoogleMaps_Width = '';
FCKConfig.GoogleMaps_Height = '';
FCKConfig.GoogleMaps_CenterLat = '';
FCKConfig.GoogleMaps_CenterLon = '';
FCKConfig.GoogleMaps_Zoom = '1';
FCKConfig.GoogleMaps_MarkerText = '';
