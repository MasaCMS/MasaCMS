	...
	<form class="form-horizontal" action="index.cfm" method="post">
		...
		<div class="block-content tab-content">
			...
			<div class="tab-pane" id="tab-admin">
					...
					<div class="mura-control-group">
						<label>Super Admin Username <span data-toggle="popover" title="" data-placement="right" data-content="This creates a master user account with full access to all Masa CMS features. The password may be changed in the admin area once the site setup is complete. Additional users with various levels of access may also be added from within the Masa CMS admin. Be sure to use a strong, secure password." data-original-title="Super Admin Username"> <i class="mi-question-circle"></i> </span></label>
			...
			<div class="tab-pane" id="tab-options">
					...
					<p class="help-block"><strong>Step 3:</strong> Select whether "index.cfm" and the Site ID should appear in Masa CMS's navigation links
					</p>
					...
					<div class="mura-control-group" >
						...
						<label class="css-input switch switch-sm switch-primary">
							...
							><span></span> <label>Use /SiteID/ in navigation links</label>
								<span data-toggle="popover" title="" data-placement="right" data-content="If enabled, navigation links and content menus generated by Masa CMS will include the siteid string. (See example url below.) To use Masa CMS with this setting turned off, include the appropriate rewriting rule in a web.config or .htaccess file." data-original-title="Site ID in navigation links"> <i class="mi-question-circle"></i> </span>
