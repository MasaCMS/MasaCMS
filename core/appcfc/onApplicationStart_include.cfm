...
if ( application.setupComplete ) {
  ...
  if(fileExists(expandPath("/mura/content/file/image.cfc"))){
	...
	variables.serviceList="utility,pluginManager,settingsManager,fileManager,contentManager,eventManager,contentRenderer,contentUtility,contentGateway,categoryManager,clusterManager,contentServer,changesetManager,scriptProtectionFilter,permUtility,emailManager,loginManager,mailinglistManager,userManager,dataCollectionManager,feedManager,sessionTrackingManager,favoriteManager,raterManager,dashboardManager,autoUpdater";
