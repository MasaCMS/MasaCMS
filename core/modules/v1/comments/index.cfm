...
<cfoutput>
	...
	<script>
		...
		$(function(){
			Mura.loader().loadjs(
				"#variables.$.globalConfig('context')#/core/modules/v1/comments/js/comments.js",
				function(){
					initMuraComments({proxyPath:"#variables.$.globalConfig('context')#/core/modules/v1/comments/ajax/commentsProxy.cfc"});
				}
			);
		});
	</script>
