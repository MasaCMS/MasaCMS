...
<ul class="#this.ulTopClass#"><cfloop query="variables.rs">
	...
	<li class="last #this.navLiClass#"><a href="#variables.viewAllURL#" <cfif not len(variables.$.event('categoryID'))>class="#this.aCurrentClass#"<cfelse>class="#this.aNotCurrentClass#"</cfif>>#$.getRBKey('list.viewall')#</a><cfif useRss><a class="rss" href="#variables.$.globalConfig('context')#/tasks/feed/index.cfm?siteid=#variables.$.event('siteID')#&contentID=#variables.rsSection.contentid#">RSS</a></cfif></li>
</ul>
</div>
