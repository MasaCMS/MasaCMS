component extends="mura.cfobject" {
	...
	variables.deprecationLogDescription = {
		...
		, StoreSetACL = "When resizing an image and directImages=true in the contentrenderer.cfc and uploading it to AWS S3, then Masa also set the ACL on your bucket. This feature is deprecated."
	};
