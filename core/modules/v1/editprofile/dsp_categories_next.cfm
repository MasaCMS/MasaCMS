...
<cf_dsp_categories_nest siteID="#attributes.siteID#" parentID="#variables.rslist.categoryID#" categoryID="#attributes.categoryID#" nestLevel="#val(attributes.nestLevel +1)#" >
</li>
</cfoutput>
</ul>
</cfif>
