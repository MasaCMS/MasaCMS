...
--->
<cfcomponent extends="mura.cfobject" output="false" hint="This provides content html exporting functionality">
...
<cffunction name="exportNode" output="false">
	...
	<cfif len(arguments.contentBean.getFileID()) and not structKeyExists(request.exportedfiles,hash(arguments.contentBean.getFileID(),'CFMX_COMPAT'))>
			...
			<cfset request.exportedfiles[hash(arguments.contentBean.getFileID(),'CFMX_COMPAT')]=true>
	</cfif>
