...
<cffunction name="create" output="false">
      ...
      VALUES (
		...
		<cfqueryparam cfsqltype="cf_sql_numeric" value="#arguments.contentBean.getActive()#">,
		<cfqueryparam cfsqltype="cf_sql_numeric" value="#arguments.contentBean.getOrderNo()#">,
		<cfqueryparam cfsqltype="cf_sql_numeric" value="#arguments.contentBean.getApproved()#">,
		...
		<cfqueryparam cfsqltype="cf_sql_numeric" value="#arguments.contentBean.getDisplay()#">,
		...
		<cfqueryparam cfsqltype="cf_sql_numeric" value="#arguments.contentBean.getisnav()#">,
		<cfqueryparam cfsqltype="cf_sql_numeric" value="#arguments.contentBean.getrestricted()#">,
		...
		<cfqueryparam cfsqltype="cf_sql_numeric" value="#arguments.contentBean.getresponseChart()#">,
		...
		<cfqueryparam cfsqltype="cf_sql_numeric" value="#arguments.contentBean.getisfeature()#">,
		...
		<CFIF arguments.contentBean.getTarget() EQ "_blank" and arguments.contentBean.getTargetParams() NEQ ""> <cfqueryparam cfsqltype="cf_sql_varchar" null="no" value="#arguments.contentBean.getTargetParams()#"><CFELSE> Null </CFIF>,
			<cfqueryparam cfsqltype="cf_sql_numeric" value="#arguments.contentBean.getIsLocked()#">,
		...
		<cfqueryparam cfsqltype="cf_sql_numeric" value="#arguments.contentBean.getSearchExclude()#">,
		<cfqueryparam cfsqltype="cf_sql_numeric" value="#arguments.contentBean.getDisplayTitle()#">,
		<cfqueryparam cfsqltype="cf_sql_numeric" value="#arguments.contentBean.getDoCache()#">,
