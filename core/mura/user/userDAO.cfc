...
<cfargument name="userBean" type="any" />
 ...
 <cfquery>
     ...
     VALUES(
         ...
         <cfqueryparam cfsqltype="cf_sql_varchar" null="#iif(arguments.userBean.getPassword() neq '',de('no'),de('yes'))#" value="#encryptPassword(arguments.userBean.getPassword())#">,
 	...
 	<cfquery>
      UPDATE tusers SET
        ...
        <cfif arguments.userBean.getPassword() neq ''>
		 Password = <cfqueryparam cfsqltype="cf_sql_varchar" null="#iif(arguments.userBean.getPassword() neq '',de('no'),de('yes'))#" value="#encryptPassword(arguments.userBean.getPassword())#">,
...
<cffunction name="savePassword" output="false">
	...
	<cfargument name="password" type="string" />
	 ...
	 <cfquery>
      UPDATE tusers SET
	  	 password =  <cfqueryparam cfsqltype="cf_sql_varchar" null="#iif(arguments.password neq '',de('no'),de('yes'))#" value="#encryptPassword(arguments.userBean.getPassword())#">,
		 passwordCreated =<cfqueryparam cfsqltype="cf_sql_timestamp" value="#now()#">
       WHERE UserID =<cfqueryparam cfsqltype="cf_sql_varchar" value="#arguments.userID#">
   </CFQUERY>
</cffunction>
