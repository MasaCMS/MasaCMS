			...
			<div class="mura-panel-body">
				<div class="container">
					...
					<div class="mura-control-group">
						...
						<div class="input-group mura-colorpicker" id="innerbackgroundcustom" style="<cfif isArray(request.colorOptions) and arrayLen(request.colorOptions)>display: none;</cfif>">
					...
					<div class="mura-control-group inner-css-bg-option" style="display:none;">
					...
					<div class="mura-control-group mura-ui-grid inner-css-bg-option" style="display:none;">
